...
### Custom Grammars (`.claude-mem-plus.json`)

You can register additional tree-sitter grammars for file types not in the bundled list. Create or update `.claude-mem-plus.json` in your project root:
