"use strict";var vt=Object.create;var G=Object.defineProperty;var Dt=Object.getOwnPropertyDescriptor;var Mt=Object.getOwnPropertyNames;var Ut=Object.getPrototypeOf,xt=Object.prototype.hasOwnProperty;var wt=(r,e)=>{for(var t in e)G(r,t,{get:e[t],enumerable:!0})},Re=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Mt(e))!xt.call(r,n)&&n!==t&&G(r,n,{get:()=>e[n],enumerable:!(s=Dt(e,n))||s.enumerable});return r};var x=(r,e,t)=>(t=r!=null?vt(Ut(r)):{},Re(e||!r||!r.__esModule?G(t,"default",{value:r,enumerable:!0}):t,r)),kt=r=>Re(G({},"__esModule",{value:!0}),r);var ps={};wt(ps,{generateContext:()=>be});module.exports=kt(ps);var Ct=x(require("path"),1),Lt=require("os"),yt=require("fs");var de=require("bun:sqlite");var f=require("path"),X=require("os"),v=require("fs");var Ne=require("url");var y=require("fs"),Ae=require("path");var te=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(te||{}),se=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=w.logsDir();(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ae.join)(e,`claude-mem-plus-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=w.settings();if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=te[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{_=" "+this.formatData(o)}else _=" "+this.formatData(o);let T="";if(n){let{sessionId:g,memorySessionId:h,correlationId:S,...m}=n;Object.keys(m).length>0&&(T=` {${Object.entries(m).map(([b,l])=>`${b}=${l}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${p}${s}${T}${_}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,E+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",T={...s,location:_};return this.warn(e,`[HAPPY-PATH] ${t}`,T,n),o}},u=new se;var qt={};function Pt(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Ne.fileURLToPath)(qt.url))}var Ft=Pt();function $t(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,X.homedir)(),".claude-mem-plus"),e=(0,f.join)((0,X.homedir)(),".claude-mem");for(let t of[r,e]){let s=(0,f.join)(t,"settings.json");try{if((0,v.existsSync)(s)){let n=JSON.parse((0,v.readFileSync)(s,"utf-8")),o=n.env??n;return o.CLAUDE_MEM_DATA_DIR?o.CLAUDE_MEM_DATA_DIR:t}}catch{}}return r}var O=$t(),D=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,X.homedir)(),".claude"),fs=(0,f.join)(D,"plugins","marketplaces","bjarne56"),jt=(0,f.join)(O,"archives"),Ht=(0,f.join)(O,"logs"),Gt=(0,f.join)(O,"trash"),Xt=(0,f.join)(O,"backups"),Bt=(0,f.join)(O,"modes"),hs=(0,f.join)(O,"settings.json"),re=(0,f.join)(O,"claude-mem.db"),Wt=(0,f.join)(O,"vector-db"),Ie=(0,f.join)(O,"observer-sessions"),ne=(0,f.basename)(Ie),Ss=(0,f.join)(D,"settings.json"),bs=(0,f.join)(D,"commands"),Os=(0,f.join)(D,"CLAUDE.md");function oe(r){(0,v.mkdirSync)(r,{recursive:!0})}function Ce(){return(0,f.join)(Ft,"..")}var w={dataDir:()=>O,workerPid:()=>(0,f.join)(O,"worker.pid"),settings:()=>(0,f.join)(O,"settings.json"),database:()=>(0,f.join)(O,"claude-mem.db"),chroma:()=>(0,f.join)(O,"chroma"),combinedCerts:()=>(0,f.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,f.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,f.join)(O,"transcript-watch-state.json"),corpora:()=>(0,f.join)(O,"corpora"),supervisorRegistry:()=>(0,f.join)(O,"supervisor.json"),envFile:()=>(0,f.join)(O,".env"),logsDir:()=>Ht,archives:()=>jt,trash:()=>Gt,backups:()=>Xt,modes:()=>Bt,vectorDb:()=>Wt,observerSessions:()=>Ie};var Ue=require("crypto");var ye=require("os"),ve=x(require("path"),1);var W=require("fs"),B=x(require("path"),1),k={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Le(r){let e=B.default.join(r,".git"),t;try{t=(0,W.statSync)(e)}catch(_){return _ instanceof Error&&_.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",_),k}if(!t.isFile())return k;let s;try{s=(0,W.readFileSync)(e,"utf-8").trim()}catch(_){return console.warn("[worktree] Failed to read .git file:",_ instanceof Error?_.message:String(_)),k}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return k;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return k;let a=i[1],d=B.default.basename(r),p=B.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:p}}function De(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,ye.homedir)()):r}function Me(r){if(!r||r.trim()==="")return u.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=De(r),t=ve.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return u.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return u.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function ie(r){let e=Me(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=De(r),s=Le(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}var Vt=require("bun:sqlite");function q(r,e,t){return(0,Ue.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ae(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var N="claude";function Yt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function M(r){if(!r)return N;let e=Yt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:N}function xe(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Kt(r,e){return{customTitle:r,platformSource:e?M(e):void 0}}var V=class{db;constructor(e=re){e instanceof de.Database?this.db=e:(e!==":memory:"&&oe(O),this.db=new de.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addPendingMessagesToolUseIdAndWorkerPidColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.dropWorkerPidColumn(),this.ensureProjectsTables()}ensureProjectsTables(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(33))return;this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,p=s==="relevance",_=p?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,T=n?`LIMIT ${n}`:"",E=e.map(()=>"?").join(","),g=[...e],h=[];if(o&&(h.push("project = ?"),g.push(o)),i)if(Array.isArray(i)){let l=i.map(()=>"?").join(",");h.push(`type IN (${l})`),g.push(...i)}else h.push("type = ?"),g.push(i);if(a){let l=Array.isArray(a)?a:[a],L=l.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");g.push(...l),h.push(`(${L.join(" OR ")})`)}if(d){let l=Array.isArray(d)?d:[d],L=l.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");l.forEach(U=>{g.push(`%${U}%`,`%${U}%`)}),h.push(`(${L.join(" OR ")})`)}let S=h.length>0?`WHERE id IN (${E}) AND ${h.join(" AND ")}`:`WHERE id IN (${E})`,A=this.db.prepare(`
      SELECT *
      FROM observations
      ${S}
      ${_}
      ${T}
    `).all(...g);if(!p)return A;let b=new Map(A.map(l=>[l.id,l]));return e.map(l=>b.get(l)).filter(l=>!!l)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Kt(n,o),p=d.platformSource??N,_=this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),p=new Date(d).toISOString(),_=q(e,s.title,s.narrative),E=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(_.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let p=a??Date.now(),_=new Date(p).toISOString();return this.db.transaction(()=>{let E=[],g=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),h=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let m of s){let A=q(e,m.title,m.narrative),b=g.get(e,t,m.type,m.title,m.subtitle,JSON.stringify(m.facts),m.narrative,JSON.stringify(m.concepts),JSON.stringify(m.files_read),JSON.stringify(m.files_modified),o||null,i,m.agent_type??null,m.agent_id??null,A,_,p,d||null);if(b){E.push(b.id);continue}let l=h.get(e,A);if(!l)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${A}`);E.push(l.id)}let S=null;if(n){let A=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,_,p);S=Number(A.lastInsertRowid)}return{observationIds:E,summaryId:S,createdAtEpoch:p}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,p,_){let T=p??Date.now(),E=new Date(T).toISOString();return this.db.transaction(()=>{let h=[],S=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),m=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let l of s){let L=q(e,l.title,l.narrative),U=S.get(e,t,l.type,l.title,l.subtitle,JSON.stringify(l.facts),l.narrative,JSON.stringify(l.concepts),JSON.stringify(l.files_read),JSON.stringify(l.files_modified),a||null,d,l.agent_type??null,l.agent_id??null,L,E,T,_||null);if(U){h.push(U.id);continue}let Oe=m.get(e,L);if(!Oe)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${L}`);h.push(Oe.id)}let A;if(n){let L=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,E,T);A=Number(L.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(T,o),{observationIds:h,summaryId:A,createdAtEpoch:T}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",p=e.map(()=>"?").join(","),_=[...e],T=o?`WHERE id IN (${p}) AND project = ?`:`WHERE id IN (${p})`;o&&_.push(o);let g=this.db.prepare(`
      SELECT * FROM session_summaries
      ${T}
      ${a}
      ${d}
    `).all(..._);if(!i)return g;let h=new Map(g.map(S=>[S.id,S]));return e.map(S=>h.get(S)).filter(S=>!!S)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",p=e.map(()=>"?").join(","),_=[...e],T=o?"AND s.project = ?":"";o&&_.push(o);let g=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(..._);if(!i)return g;let h=new Map(g.map(S=>[S.id,S]));return e.map(S=>h.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,p;if(e!==null){let m=`
