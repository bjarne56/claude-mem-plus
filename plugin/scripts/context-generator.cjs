"use strict";var Dt=Object.create;var G=Object.defineProperty;var Mt=Object.getOwnPropertyDescriptor;var Ut=Object.getOwnPropertyNames;var xt=Object.getPrototypeOf,wt=Object.prototype.hasOwnProperty;var kt=(r,e)=>{for(var t in e)G(r,t,{get:e[t],enumerable:!0})},he=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ut(e))!wt.call(r,n)&&n!==t&&G(r,n,{get:()=>e[n],enumerable:!(s=Mt(e,n))||s.enumerable});return r};var v=(r,e,t)=>(t=r!=null?Dt(xt(r)):{},he(e||!r||!r.__esModule?G(t,"default",{value:r,enumerable:!0}):t,r)),$t=r=>he(G({},"__esModule",{value:!0}),r);var ds={};kt(ds,{generateContext:()=>Se});module.exports=$t(ds);var Lt=v(require("path"),1),yt=require("os"),vt=require("fs");var ie=require("bun:sqlite");var h=require("path"),se=require("os"),X=require("fs");var Re=require("url");var y=require("fs"),x=require("path"),Ae=require("os"),ee=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(ee||{}),Oe=(0,x.join)((0,Ae.homedir)(),".claude-mem"),te=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,x.join)(Oe,"logs");(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,x.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,x.join)(Oe,"settings.json");if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ee[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{u=" "+this.formatData(o)}else u=" "+this.formatData(o);let T="";if(n){let{sessionId:g,memorySessionId:f,correlationId:S,...p}=n;Object.keys(p).length>0&&(T=` {${Object.entries(p).map(([b,l])=>`${b}=${l}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${m}${s}${T}${u}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,E+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=m?`${m[1].split("/").pop()}:${m[2]}`:"unknown",T={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,T,n),o}},c=new te;var Xt={};function Ft(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,Re.fileURLToPath)(Xt.url))}var Pt=Ft();function Ht(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,h.join)((0,se.homedir)(),".claude-mem"),e=(0,h.join)(r,"settings.json");try{if((0,X.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var I=Ht(),D=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,se.homedir)(),".claude"),ls=(0,h.join)(D,"plugins","marketplaces","thedotmack"),ps=(0,h.join)(I,"archives"),Es=(0,h.join)(I,"logs"),gs=(0,h.join)(I,"trash"),Ts=(0,h.join)(I,"backups"),fs=(0,h.join)(I,"modes"),Ss=(0,h.join)(I,"settings.json"),Ne=(0,h.join)(I,"claude-mem.db"),bs=(0,h.join)(I,"vector-db"),Gt=(0,h.join)(I,"observer-sessions"),re=(0,h.basename)(Gt),hs=(0,h.join)(D,"settings.json"),Os=(0,h.join)(D,"commands"),As=(0,h.join)(D,"CLAUDE.md");function Ie(r){(0,X.mkdirSync)(r,{recursive:!0})}function Ce(){return(0,h.join)(Pt,"..")}var Me=require("crypto");var ye=require("os"),ve=v(require("path"),1);var B=require("fs"),j=v(require("path"),1),w={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Le(r){let e=j.default.join(r,".git"),t;try{t=(0,B.statSync)(e)}catch(u){return u instanceof Error&&u.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",u),w}if(!t.isFile())return w;let s;try{s=(0,B.readFileSync)(e,"utf-8").trim()}catch(u){return console.warn("[worktree] Failed to read .git file:",u instanceof Error?u.message:String(u)),w}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return w;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return w;let a=i[1],d=j.default.basename(r),m=j.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:m}}function De(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,ye.homedir)()):r}function jt(r){if(!r||r.trim()==="")return c.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=De(r),t=ve.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return c.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return c.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function ne(r){let e=jt(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=De(r),s=Le(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function W(r,e,t){return(0,Me.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function oe(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var R="claude";function Bt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function M(r){if(!r)return R;let e=Bt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:R}function Ue(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Wt(r,e){return{customTitle:r,platformSource:e?M(e):void 0}}var q=class{db;constructor(e=Ne){e instanceof ie.Database?this.db=e:(e!==":memory:"&&Ie(I),this.db=new ie.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addPendingMessagesToolUseIdAndWorkerPidColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,m=s==="relevance",u=m?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,T=n?`LIMIT ${n}`:"",E=e.map(()=>"?").join(","),g=[...e],f=[];if(o&&(f.push("project = ?"),g.push(o)),i)if(Array.isArray(i)){let l=i.map(()=>"?").join(",");f.push(`type IN (${l})`),g.push(...i)}else f.push("type = ?"),g.push(i);if(a){let l=Array.isArray(a)?a:[a],L=l.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");g.push(...l),f.push(`(${L.join(" OR ")})`)}if(d){let l=Array.isArray(d)?d:[d],L=l.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");l.forEach(U=>{g.push(`%${U}%`,`%${U}%`)}),f.push(`(${L.join(" OR ")})`)}let S=f.length>0?`WHERE id IN (${E}) AND ${f.join(" AND ")}`:`WHERE id IN (${E})`,A=this.db.prepare(`
      SELECT *
      FROM observations
      ${S}
      ${m}
      ${T}
    `).all(...g);if(!m)return A;let b=new Map(A.map(l=>[l.id,l]));return e.map(l=>b.get(l)).filter(l=>!!l)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Wt(n,o),m=d.platformSource??R,u=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let m=a??Date.now(),u=new Date(m).toISOString();return this.db.transaction(()=>{let E=[],g=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),f=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let p of s){let A=W(e,p.title,p.narrative),b=g.get(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),o||null,i,p.agent_type??null,p.agent_id??null,A,u,m,d||null);if(b){E.push(b.id);continue}let l=f.get(e,A);if(!l)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${A}`);E.push(l.id)}let S=null;if(n){let A=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,u,m);S=Number(A.lastInsertRowid)}return{observationIds:E,summaryId:S,createdAtEpoch:m}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,m,u){let T=m??Date.now(),E=new Date(T).toISOString();return this.db.transaction(()=>{let f=[],S=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),p=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let l of s){let L=W(e,l.title,l.narrative),U=S.get(e,t,l.type,l.title,l.subtitle,JSON.stringify(l.facts),l.narrative,JSON.stringify(l.concepts),JSON.stringify(l.files_read),JSON.stringify(l.files_modified),a||null,d,l.agent_type??null,l.agent_id??null,L,E,T,u||null);if(U){f.push(U.id);continue}let be=p.get(e,L);if(!be)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${L}`);f.push(be.id)}let A;if(n){let L=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ...
    `).all(...u);if(!i)return g;let f=new Map(g.map(S=>[S.id,S]));return e.map(S=>f.get(S)).filter(S=>!!S)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),u=[...e],T=o?"AND s.project = ?":"";o&&u.push(o);let g=this.db.prepare(`
      ...
      ${a}
      ${d}
    `).all(...u);if(!i)return g;let f=new Map(g.map(S=>[S.id,S]));return e.map(S=>f.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,m;if(e!==null){let p=`
      ...
      `,A=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let b=this.db.prepare(p).all(e,...a,s+1),l=this.db.prepare(A).all(e,...a,n+1);if(b.length===0&&l.length===0)return{observations:[],sessions:[],prompts:[]};d=b.length>0?b[b.length-1].created_at_epoch:t,m=l.length>0?l[l.length-1].created_at_epoch:t}catch(b){return b instanceof Error?c.error("DB","Error getting boundary observations",{project:o},b):c.error("DB","Error getting boundary observations with non-Error",{},new Error(String(b))),{observations:[],sessions:[],prompts:[]}}}else{let p=`
      ...
      `,A=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let b=this.db.prepare(p).all(t,...a,s),l=this.db.prepare(A).all(t,...a,n+1);if(b.length===0&&l.length===0)return{observations:[],sessions:[],prompts:[]};d=b.length>0?b[b.length-1].created_at_epoch:t,m=l.length>0?l[l.length-1].created_at_epoch:t}catch(b){return b instanceof Error?c.error("DB","Error getting boundary timestamps",{project:o},b):c.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(b))),{observations:[],sessions:[],prompts:[]}}}let u=`
      SELECT *
      FROM observations
  ...
  `).all(...e,...e,...s,...o,t.totalObservationCount)}function He(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t.sessionCount+_e)}function Vt(r){return r.replace(/\//g,"-")}function Jt(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace($e,"").trim(),t)return t}return null}function Qt(r){for(let e=r.length-1;e>=0;e--)try{let t=Jt(r[e]);if(t)return t}catch(t){t instanceof Error?c.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):c.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function zt(r){try{if(!(0,J.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,J.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{userMessage:"",assistantMessage:Qt(t)}}catch(e){return e instanceof Error?c.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):c.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{userMessage:"",assistantMessage:""}}}function pe(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=Vt(s),a=Fe.default.join(D,"projects",i,`${o}.jsonl`);return zt(a)}function Ge(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Ee(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function Xe(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function je(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Be(r){return[`# [${r}] recent context, ${je()}`,""]}function We(){return[`Legend: \u{1F3AF}session ${N.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function qe(){return[]}function Ke(){return[]}function Ye(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function Ve(r){return[`### ${r}`]}function Je(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function Qe(r,e,t){let s=r.title||"Untitled",n=N.getInstance().getTypeIcon(r.type),o=e?Je(e):'"';return`${r.id} ${o} ${n} ${s}`}function ze(r,e,t,s){let n=[],o=r.title||"Untitled",i=N.getInstance().getTypeIcon(r.type),a=e?Je(e):'"',{readTokens:d,discoveryDisplay:m}=F(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let u=[];return s.showReadTokens&&u.push(`~${d}t`),s.showWorkTokens&&u.push(m),u.length>0&&n.push(u.join(" ")),n.push(""),n}function Ze(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function P(r,e){return e?[`**${r}**: ${e}`,""]:[]}function et(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function tt(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function st(r){return`# [${r}] recent context, ${je()}

No previous sessions found.`}var rt={zh:{recentContext:"\u6700\u8FD1\u4E0A\u4E0B\u6587",legend:"\u56FE\u4F8B",legendSession:"\u4F1A\u8BDD\u8BF7\u6C42",columnKey:"\u5217\u8BF4\u660E",colReadDesc:"\u9605\u8BFB\u8FD9\u6761 observation \u7684\u8BCD\u5143\u6570(\u73B0\u5728\u5B66\u7684\u6210\u672C)",colWorkDesc:"\u4EA7\u51FA\u8FD9\u6761\u8BB0\u5F55\u82B1\u7684\u5DE5\u4F5C\u8BCD\u5143(\u8C03\u7814 / \u6784\u5EFA / \u51B3\u7B56)",contextIndex:"\u4E0A\u4E0B\u6587\u7D22\u5F15: \u8FD9\u4EFD\u8BED\u4E49\u7D22\u5F15(\u6807\u9898 / \u7C7B\u578B / \u6587\u4EF6 / \u8BCD\u5143)\u901A\u5E38\u8DB3\u4EE5\u7406\u89E3\u8FC7\u5F80\u5DE5\u4F5C\u3002",whenNeed:"\u5F53\u4F60\u9700\u8981\u5B9E\u73B0\u7EC6\u8282\u3001\u539F\u56E0\u6216\u8C03\u8BD5\u4E0A\u4E0B\u6587\u65F6:",fetchById:"\u6309 ID \u53D6: get_observations([IDs]) \u62C9\u53D6\u672C\u7D22\u5F15\u53EF\u89C1\u7684 observation",searchHistory:"\u641C\u5386\u53F2: \u7528 mem-search skill \u67E5\u8FC7\u5F80\u51B3\u7B56\u3001bug \u4E0E\u6DF1\u5EA6\u8C03\u7814",trustIndex:"\u4FE1\u4EFB\u672C\u7D22\u5F15,\u4E0D\u5FC5\u4E3A\u67E5\u8FC7\u5F80\u51B3\u7B56\u548C\u5B66\u5230\u7684\u5185\u5BB9\u91CD\u65B0\u8BFB\u4EE3\u7801",contextEconomics:"\u4E0A\u4E0B\u6587\u7ECF\u6D4E",loading:(r,e)=>`\u8F7D\u5165: ${r} \u6761 observation (${e} \u8BCD\u5143\u5F85\u8BFB)`,workInvest:r=>`\u5DE5\u4F5C\u6295\u5165: ${r} \u8BCD\u5143\u7528\u4E8E\u8C03\u7814\u3001\u6784\u5EFA\u4E0E\u51B3\u7B56`,yourSavings:"\u4F60\u8282\u7701",tokensSavings:(r,e)=>`${r} \u8BCD\u5143(\u590D\u7528\u51CF\u5C11 ${e}%)`,tokensOnly:r=>`${r} \u8BCD\u5143`,pctOnly:r=>`\u590D\u7528\u51CF\u5C11 ${r}%`,untitled:"\u672A\u547D\u540D",sessionStarted:"\u4F1A\u8BDD\u5F00\u59CB",previously:"\u4E4B\u524D",footerAccess:(r,e)=>`\u7528 ${e}t \u8BCD\u5143\u8BBF\u95EE\u8FC7\u5F80 ${r}k \u8BCD\u5143\u7684\u8C03\u7814\u4E0E\u51B3\u7B56\u3002\u7528 claude-mem skill \u6309 ID \u53D6\u8BB0\u5FC6\u3002`,emptyState:"\u672C\u9879\u76EE\u6682\u65E0\u8FC7\u5F80\u4F1A\u8BDD\u3002"},en:{recentContext:"recent context",legend:"Legend",legendSession:"session-request",columnKey:"Column Key",colReadDesc:"Tokens to read this observation (cost to learn it now)",colWorkDesc:"Tokens spent on work that produced this record (research, building, deciding)",contextIndex:"Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.",whenNeed:"When you need implementation details, rationale, or debugging context:",fetchById:"Fetch by ID: get_observations([IDs]) for observations visible in this index",searchHistory:"Search history: Use the mem-search skill for past decisions, bugs, and deeper research",trustIndex:"Trust this index over re-reading code for past decisions and learnings",contextEconomics:"Context Economics",loading:(r,e)=>`Loading: ${r} observations (${e} tokens to read)`,workInvest:r=>`Work investment: ${r} tokens spent on research, building, and decisions`,yourSavings:"Your savings",tokensSavings:(r,e)=>`${r} tokens (${e}% reduction from reuse)`,tokensOnly:r=>`${r} tokens`,pctOnly:r=>`${r}% reduction from reuse`,untitled:"Untitled",sessionStarted:"Session started",previously:"Previously",footerAccess:(r,e)=>`Access ${r}k tokens of past research & decisions for just ${e}t. Use the claude-mem skill to access memories by ID.`,emptyState:"No previous sessions found for this project yet."}},Zt="zh";function O(){return rt[Zt]||rt.en}function nt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function ot(r){return["",`${_.bright}${_.cyan}[${r}] ${O().recentContext}, ${nt()}${_.reset}`,`${_.gray}${"\u2500".repeat(60)}${_.reset}`,""]}function it(){let e=N.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${_.dim}${O().legend}: ${O().legendSession} | ${e}${_.reset}`,""]}function at(){return[`${_.bright}${O().columnKey}${_.reset}`,`${_.dim}  Read: ${O().colReadDesc}${_.reset}`,`${_.dim}  Work: ${O().colWorkDesc}${_.reset}`,""]}function dt(){return[`${_.dim}${O().contextIndex}${_.reset}`,"",`${_.dim}${O().whenNeed}${_.reset}`,`${_.dim}  - ${O().fetchById}${_.reset}`,`${_.dim}  - ${O().searchHistory}${_.reset}`,`${_.dim}  - ${O().trustIndex}${_.reset}`,""]}function _t(r,e){let t=[],s=O();if(t.push(`${_.bright}${_.cyan}${s.contextEconomics}${_.reset}`),t.push(`${_.dim}  ${s.loading(r.totalObservations,r.totalReadTokens.toLocaleString())}${_.reset}`),t.push(`${_.dim}  ${s.workInvest(r.totalDiscoveryTokens.toLocaleString())}${_.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let n=`  ${s.yourSavings}: `;e.showSavingsAmount&&e.showSavingsPercent?n+=s.tokensSavings(r.savings.toLocaleString(),r.savingsPercent):e.showSavingsAmount?n+=s.tokensOnly(r.savings.toLocaleString()):n+=s.pctOnly(r.savingsPercent),t.push(`${_.green}${n}${_.reset}`)}return t.push(""),t}function ut(r){return[`${_.bright}${_.cyan}${r}${_.reset}`,""]}function ct(r){return[`${_.dim}${r}${_.reset}`]}function mt(r,e,t,s){let n=r.title||O().untitled,o=N.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=F(r,s),m=t?`${_.dim}${e}${_.reset}`:" ".repeat(e.length),u=s.showReadTokens&&i>0?`${_.dim}(~${i}t)${_.reset}`:"",T=s.showWorkTokens&&a>0?`${_.dim}(${d} ${a.toLocaleString()}t)${_.reset}`:"";return`  ${_.dim}#${r.id}${_.reset}  ${m}  ${o}  ${n} ${u} ${T}`}function lt(r,e,t,s,n){let o=[],i=r.title||O().untitled,a=N.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:m,workEmoji:u}=F(r,n),T=t?`${_.dim}${e}${_.reset}`:" ".repeat(e.length),E=n.showReadTokens&&d>0?`${_.dim}(~${d}t)${_.reset}`:"",g=n.showWorkTokens&&m>0?`${_.dim}(${u} ${m.toLocaleString()}t)${_.reset}`:"";return o.push(`  ${_.dim}#${r.id}${_.reset}  ${T}  ${a}  ${_.bright}${i}${_.reset}`),s&&o.push(`    ${_.dim}${s}${_.reset}`),(E||g)&&o.push(`    ${E} ${g}`),o.push(""),o}function pt(r,e){let t=`${r.request||O().sessionStarted} (${e})`;return[`${_.yellow}#S${r.id}${_.reset} ${t}`,""]}function H(r,e,t){return e?[`${t}${r}:${_.reset} ${e}`,""]:[]}function Et(r){return r.assistantMessage?["","---","",`${_.bright}${_.magenta}${O().previously}${_.reset}`,"",`${_.dim}A: ${r.assistantMessage}${_.reset}`,""]:[]}function gt(r,e){let t=Math.round(r/1e3);return["",`${_.dim}${O().footerAccess(t,e.toLocaleString())}${_.reset}`]}function Tt(r){return`
${_.bright}${_.cyan}[${r}] ${O().recentContext}, ${nt()}${_.reset}
${_.gray}${"\u2500".repeat(60)}${_.reset}

${_.dim}${O().emptyState}${_.reset}
`}function ft(r,e,t,s){let n=[];return s?n.push(...ot(r)):n.push(...Be(r)),s?n.push(...it()):n.push(...We()),s?n.push(...at()):n.push(...qe()),s?n.push(...dt()):n.push(...Ke()),V(t)&&(s?n.push(..._t(e,t)):n.push(...Ye(e,t))),n}var ge=v(require("path"),1);function Z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return c.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Te(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function fe(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function bt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function St(r,e){return ge.default.isAbsolute(r)?ge.default.relative(e,r):r}function ht(r,e,t){let s=Z(r);if(s.length>0)return St(s[0],e);if(t){let n=Z(t);if(n.length>0)return St(n[0],e)}return"General"}function es(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=bt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Ot(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Z(r.facts).join(`
`):null}function ts(r,e,t,s){let n=[];n.push(...Ve(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Te(a.displayTime);n.push(...Ze(a,d))}else{let a=i.data,d=fe(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let E=Ot(a,s);n.push(...ze(a,u,E,s))}else n.push(Qe(a,u,s))}return n}function ss(r,e,t,s,n){let o=[];o.push(...ut(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let m=d.data,u=Te(m.displayTime);o.push(...pt(m,u))}else{let m=d.data,u=ht(m.files_modified,n,m.files_read),T=fe(m.created_at),E=T!==a;a=T;let g=t.has(m.id);if(u!==i&&(o.push(...ct(u)),i=u),g){let f=Ot(m,s);o.push(...lt(m,T,E,f,s))}else o.push(mt(m,T,E,s))}return o.push(""),o}function rs(r,e,t,s,n,o){return o?ss(r,e,t,s,n):ts(r,e,t,s)}function At(r,e,t,s,n){let o=[],i=es(r);for(let[a,d]of i)o.push(...rs(a,d,e,t,s,n));return o}function Rt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Nt(r,e){let t=[];return e?(t.push(...H("Investigated",r.investigated,_.blue)),t.push(...H("Learned",r.learned,_.yellow)),t.push(...H("Completed",r.completed,_.green)),t.push(...H("Next Steps",r.next_steps,_.magenta))):(t.push(...P("Investigated",r.investigated)),t.push(...P("Learned",r.learned)),t.push(...P("Completed",r.completed)),t.push(...P("Next Steps",r.next_steps))),t}function It(r,e){return e?Et(r):et(r)}function Ct(r,e,t){return!V(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?gt(r.totalDiscoveryTokens,r.totalReadTokens):tt(r.totalDiscoveryTokens,r.totalReadTokens)}var ns=Lt.default.join((0,yt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function os(){try{return new q}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,vt.unlinkSync)(ns)}catch(e){e instanceof Error?c.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):c.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return c.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function is(r,e){return e?Tt(r):st(r)}function as(r,e,t,s,n,o,i){let a=[],d=ce(e);a.push(...ft(r,d,s,i));let m=t.slice(0,s.sessionCount),u=Ge(m,t),T=Ee(e,u),E=Xe(e,s.fullObservationCount);a.push(...At(T,E,s,n,i));let g=t[0],f=e[0];Rt(s,g,f)&&a.push(...Nt(g,i));let S=pe(e,s,o,n);return a.push(...It(S,i)),a.push(...Ct(d,s,i)),a.join(`
`).trimEnd()}async function Se(r,e=!1){let t=de(),s=r?.cwd??process.cwd(),n=ne(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=os();if(!a)return"";try{let d=o.length>1?Pe(a,o,t):me(a,i,t),m=o.length>1?He(a,o,t):le(a,i,t);return d.length===0&&m.length===0?is(i,e):as(i,d,m,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
