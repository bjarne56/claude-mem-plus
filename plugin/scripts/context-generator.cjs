"use strict";var yt=Object.create;var X=Object.defineProperty;var vt=Object.getOwnPropertyDescriptor;var Dt=Object.getOwnPropertyNames;var Mt=Object.getPrototypeOf,Ut=Object.prototype.hasOwnProperty;var xt=(r,e)=>{for(var t in e)X(r,t,{get:e[t],enumerable:!0})},he=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Dt(e))!Ut.call(r,n)&&n!==t&&X(r,n,{get:()=>e[n],enumerable:!(s=vt(e,n))||s.enumerable});return r};var x=(r,e,t)=>(t=r!=null?yt(Mt(r)):{},he(e||!r||!r.__esModule?X(t,"default",{value:r,enumerable:!0}):t,r)),wt=r=>he(X({},"__esModule",{value:!0}),r);var us={};xt(us,{generateContext:()=>Se});module.exports=wt(us);var It=x(require("path"),1),Ct=require("os"),Lt=require("fs");var ie=require("bun:sqlite");var f=require("path"),se=require("os"),v=require("fs");var Re=require("url");var y=require("fs"),Oe=require("path");var ee=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(ee||{}),te=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=w.logsDir();(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Oe.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=w.settings();if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ee[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{u=" "+this.formatData(o)}else u=" "+this.formatData(o);let T="";if(n){let{sessionId:g,memorySessionId:S,correlationId:b,...p}=n;Object.keys(p).length>0&&(T=` {${Object.entries(p).map(([h,l])=>`${h}=${l}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${m}${s}${T}${u}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,E+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=m?`${m[1].split("/").pop()}:${m[2]}`:"unknown",T={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,T,n),o}},_=new te;var Wt={};function kt(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Re.fileURLToPath)(Wt.url))}var $t=kt();function Ft(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,se.homedir)(),".claude-mem"),e=(0,f.join)(r,"settings.json");try{if((0,v.existsSync)(e)){let t=JSON.parse((0,v.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var O=Ft(),D=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,se.homedir)(),".claude"),Ts=(0,f.join)(D,"plugins","marketplaces","thedotmack"),Pt=(0,f.join)(O,"archives"),Ht=(0,f.join)(O,"logs"),Gt=(0,f.join)(O,"trash"),Xt=(0,f.join)(O,"backups"),jt=(0,f.join)(O,"modes"),fs=(0,f.join)(O,"settings.json"),Ae=(0,f.join)(O,"claude-mem.db"),Bt=(0,f.join)(O,"vector-db"),Ne=(0,f.join)(O,"observer-sessions"),re=(0,f.basename)(Ne),Ss=(0,f.join)(D,"settings.json"),bs=(0,f.join)(D,"commands"),hs=(0,f.join)(D,"CLAUDE.md");function Ie(r){(0,v.mkdirSync)(r,{recursive:!0})}function Ce(){return(0,f.join)($t,"..")}var w={dataDir:()=>O,workerPid:()=>(0,f.join)(O,"worker.pid"),settings:()=>(0,f.join)(O,"settings.json"),database:()=>(0,f.join)(O,"claude-mem.db"),chroma:()=>(0,f.join)(O,"chroma"),combinedCerts:()=>(0,f.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,f.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,f.join)(O,"transcript-watch-state.json"),corpora:()=>(0,f.join)(O,"corpora"),supervisorRegistry:()=>(0,f.join)(O,"supervisor.json"),envFile:()=>(0,f.join)(O,".env"),logsDir:()=>Ht,archives:()=>Pt,trash:()=>Gt,backups:()=>Xt,modes:()=>jt,vectorDb:()=>Bt,observerSessions:()=>Ne};var Me=require("crypto");var ye=require("os"),ve=x(require("path"),1);var B=require("fs"),j=x(require("path"),1),k={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Le(r){let e=j.default.join(r,".git"),t;try{t=(0,B.statSync)(e)}catch(u){return u instanceof Error&&u.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",u),k}if(!t.isFile())return k;let s;try{s=(0,B.readFileSync)(e,"utf-8").trim()}catch(u){return console.warn("[worktree] Failed to read .git file:",u instanceof Error?u.message:String(u)),k}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return k;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return k;let a=i[1],d=j.default.basename(r),m=j.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:m}}function De(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,ye.homedir)()):r}function qt(r){if(!r||r.trim()==="")return _.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=De(r),t=ve.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return _.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return _.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function ne(r){let e=qt(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=De(r),s=Le(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function W(r,e,t){return(0,Me.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function oe(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var N="claude";function Vt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function M(r){if(!r)return N;let e=Vt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:N}function Ue(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Kt(r,e){return{customTitle:r,platformSource:e?M(e):void 0}}var q=class{db;constructor(e=Ae){e instanceof ie.Database?this.db=e:(e!==":memory:"&&Ie(O),this.db=new ie.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addPendingMessagesToolUseIdAndWorkerPidColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.dropWorkerPidColumn()}dropWorkerPidColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32))return;if(this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="worker_pid"))try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),_.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(n){_.warn("DB","Failed to drop worker_pid column from pending_messages",{},n instanceof Error?n:new Error(String(n)))}this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}dropDeadPendingMessagesColumns(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31))return;let t=this.db.query("PRAGMA table_info(pending_messages)").all(),s=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch","worker_pid"].filter(i=>s.has(i));if(o.length>0){this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)try{this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),_.debug("DB",`Dropped dead column ${i} from pending_messages`)}catch(a){_.warn("DB",`Failed to drop column ${i} from pending_messages`,{},a instanceof Error?a:new Error(String(a)))}}this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,m=s==="relevance",u=m?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,T=n?`LIMIT ${n}`:"",E=e.map(()=>"?").join(","),g=[...e],S=[];if(o&&(S.push("project = ?"),g.push(o)),i)if(Array.isArray(i)){let l=i.map(()=>"?").join(",");S.push(`type IN (${l})`),g.push(...i)}else S.push("type = ?"),g.push(i);if(a){let l=Array.isArray(a)?a:[a],L=l.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");g.push(...l),S.push(`(${L.join(" OR ")})`)}if(d){let l=Array.isArray(d)?d:[d],L=l.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");l.forEach(U=>{g.push(`%${U}%`,`%${U}%`)}),S.push(`(${L.join(" OR ")})`)}let b=S.length>0?`WHERE id IN (${E}) AND ${S.join(" AND ")}`:`WHERE id IN (${E})`,A=this.db.prepare(`
      SELECT *
      FROM observations
      ${b}
      ${u}
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Kt(n,o),m=d.platformSource??N,u=this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),m=new Date(d).toISOString(),u=W(e,s.title,s.narrative),E=this.db.prepare(`
    ...
    `).get(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,u,m,d,a||null,s.metadata??null);if(E)return{id:E.id,createdAtEpoch:E.created_at_epoch};let g=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,u);if(!g)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${u}`);return{id:g.id,createdAtEpoch:g.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),u=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let m=a??Date.now(),u=new Date(m).toISOString();return this.db.transaction(()=>{let E=[],g=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
      ...
      `),S=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let p of s){let A=W(e,p.title,p.narrative),h=g.get(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),o||null,i,p.agent_type??null,p.agent_id??null,A,u,m,d||null);if(h){E.push(h.id);continue}let l=S.get(e,A);if(!l)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${A}`);E.push(l.id)}let b=null;if(n){let A=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),p=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let l of s){let L=W(e,l.title,l.narrative),U=b.get(e,t,l.type,l.title,l.subtitle,JSON.stringify(l.facts),l.narrative,JSON.stringify(l.concepts),JSON.stringify(l.files_read),JSON.stringify(l.files_modified),a||null,d,l.agent_type??null,l.agent_id??null,L,E,T,u||null);if(U){S.push(U.id);continue}let be=p.get(e,L);if(!be)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${L}`);S.push(be.id)}let A;if(n){let L=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      ...
      `).run(T,o),{observationIds:S,summaryId:A,createdAtEpoch:T}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),u=[...e],T=o?`WHERE id IN (${m}) AND project = ?`:`WHERE id IN (${m})`;o&&u.push(o);let g=this.db.prepare(`
      SELECT * FROM session_summaries
      ${T}
      ${a}
      ${d}
    `).all(...u);if(!i)return g;let S=new Map(g.map(b=>[b.id,b]));return e.map(b=>S.get(b)).filter(b=>!!b)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),u=[...e],T=o?"AND s.project = ?":"";o&&u.push(o);let g=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(...u);if(!i)return g;let S=new Map(g.map(b=>[b.id,b]));return e.map(b=>S.get(b)).filter(b=>!!b)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,m;if(e!==null){let p=`
    ...
    `).get(e)||null}getOrCreateManualSession(e){let t=`manual-${e}`,s=`manual-content-${e}`;if(this.db.prepare("SELECT memory_session_id FROM sdk_sessions WHERE memory_session_id = ?").get(t))return t;let o=new Date;return this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, 'active')
    `).run(t,s,e,N,o.toISOString(),o.getTime()),_.info("SESSION","Created manual session",{memorySessionId:t,project:e}),t}close(){this.db.close()}importSdkSession(e){let t=this.db.prepare("SELECT id FROM sdk_sessions WHERE content_session_id = ?").get(e.content_session_id);return t?{imported:!1,id:t.id}:{imported:!0,id:this.db.prepare(`
      INSERT INTO sdk_sessions (
  ...
  `).all(...e,...e,...s,...o,t.totalObservationCount)}function Fe(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t.sessionCount+ce)}function zt(r){return r.replace(/\//g,"-")}function Zt(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(we,"").trim(),t)return t}return null}function es(r){for(let e=r.length-1;e>=0;e--)try{let t=Zt(r[e]);if(t)return t}catch(t){t instanceof Error?_.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):_.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function ts(r){try{if(!(0,J.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,J.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{userMessage:"",assistantMessage:es(t)}}catch(e){return e instanceof Error?_.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):_.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{userMessage:"",assistantMessage:""}}}function pe(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=zt(s),a=ke.default.join(D,"projects",i,`${o}.jsonl`);return ts(a)}function Pe(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Ee(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function He(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function Ge(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Xe(r){return[`# [${r}] recent context, ${Ge()}`,""]}function je(){return[`Legend: \u{1F3AF}session ${I.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function Be(){return[]}function We(){return[]}function qe(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function Ve(r){return[`### ${r}`]}function Ke(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function Ye(r,e,t){let s=r.title||"Untitled",n=I.getInstance().getTypeIcon(r.type),o=e?Ke(e):'"';return`${r.id} ${o} ${n} ${s}`}function Je(r,e,t,s){let n=[],o=r.title||"Untitled",i=I.getInstance().getTypeIcon(r.type),a=e?Ke(e):'"',{readTokens:d,discoveryDisplay:m}=P(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let u=[];return s.showReadTokens&&u.push(`~${d}t`),s.showWorkTokens&&u.push(m),u.length>0&&n.push(u.join(" ")),n.push(""),n}function Qe(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function H(r,e){return e?[`**${r}**: ${e}`,""]:[]}function ze(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function Ze(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function et(r){return`# [${r}] recent context, ${Ge()}

No previous sessions found.`}var tt={zh:{recentContext:"\u6700\u8FD1\u4E0A\u4E0B\u6587",legend:"\u56FE\u4F8B",legendSession:"\u4F1A\u8BDD\u8BF7\u6C42",columnKey:"\u5217\u8BF4\u660E",colReadDesc:"\u9605\u8BFB\u8FD9\u6761 observation \u7684\u8BCD\u5143\u6570(\u73B0\u5728\u5B66\u7684\u6210\u672C)",colWorkDesc:"\u4EA7\u51FA\u8FD9\u6761\u8BB0\u5F55\u82B1\u7684\u5DE5\u4F5C\u8BCD\u5143(\u8C03\u7814 / \u6784\u5EFA / \u51B3\u7B56)",contextIndex:"\u4E0A\u4E0B\u6587\u7D22\u5F15: \u8FD9\u4EFD\u8BED\u4E49\u7D22\u5F15(\u6807\u9898 / \u7C7B\u578B / \u6587\u4EF6 / \u8BCD\u5143)\u901A\u5E38\u8DB3\u4EE5\u7406\u89E3\u8FC7\u5F80\u5DE5\u4F5C\u3002",whenNeed:"\u5F53\u4F60\u9700\u8981\u5B9E\u73B0\u7EC6\u8282\u3001\u539F\u56E0\u6216\u8C03\u8BD5\u4E0A\u4E0B\u6587\u65F6:",fetchById:"\u6309 ID \u53D6: get_observations([IDs]) \u62C9\u53D6\u672C\u7D22\u5F15\u53EF\u89C1\u7684 observation",searchHistory:"\u641C\u5386\u53F2: \u7528 mem-search skill \u67E5\u8FC7\u5F80\u51B3\u7B56\u3001bug \u4E0E\u6DF1\u5EA6\u8C03\u7814",trustIndex:"\u4FE1\u4EFB\u672C\u7D22\u5F15,\u4E0D\u5FC5\u4E3A\u67E5\u8FC7\u5F80\u51B3\u7B56\u548C\u5B66\u5230\u7684\u5185\u5BB9\u91CD\u65B0\u8BFB\u4EE3\u7801",contextEconomics:"\u4E0A\u4E0B\u6587\u7ECF\u6D4E",loading:(r,e)=>`\u8F7D\u5165: ${r} \u6761 observation (${e} \u8BCD\u5143\u5F85\u8BFB)`,workInvest:r=>`\u5DE5\u4F5C\u6295\u5165: ${r} \u8BCD\u5143\u7528\u4E8E\u8C03\u7814\u3001\u6784\u5EFA\u4E0E\u51B3\u7B56`,yourSavings:"\u4F60\u8282\u7701",tokensSavings:(r,e)=>`${r} \u8BCD\u5143(\u590D\u7528\u51CF\u5C11 ${e}%)`,tokensOnly:r=>`${r} \u8BCD\u5143`,pctOnly:r=>`\u590D\u7528\u51CF\u5C11 ${r}%`,untitled:"\u672A\u547D\u540D",sessionStarted:"\u4F1A\u8BDD\u5F00\u59CB",previously:"\u4E4B\u524D",footerAccess:(r,e)=>`\u7528 ${e}t \u8BCD\u5143\u8BBF\u95EE\u8FC7\u5F80 ${r}k \u8BCD\u5143\u7684\u8C03\u7814\u4E0E\u51B3\u7B56\u3002\u7528 claude-mem skill \u6309 ID \u53D6\u8BB0\u5FC6\u3002`,emptyState:"\u672C\u9879\u76EE\u6682\u65E0\u8FC7\u5F80\u4F1A\u8BDD\u3002"},en:{recentContext:"recent context",legend:"Legend",legendSession:"session-request",columnKey:"Column Key",colReadDesc:"Tokens to read this observation (cost to learn it now)",colWorkDesc:"Tokens spent on work that produced this record (research, building, deciding)",contextIndex:"Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.",whenNeed:"When you need implementation details, rationale, or debugging context:",fetchById:"Fetch by ID: get_observations([IDs]) for observations visible in this index",searchHistory:"Search history: Use the mem-search skill for past decisions, bugs, and deeper research",trustIndex:"Trust this index over re-reading code for past decisions and learnings",contextEconomics:"Context Economics",loading:(r,e)=>`Loading: ${r} observations (${e} tokens to read)`,workInvest:r=>`Work investment: ${r} tokens spent on research, building, and decisions`,yourSavings:"Your savings",tokensSavings:(r,e)=>`${r} tokens (${e}% reduction from reuse)`,tokensOnly:r=>`${r} tokens`,pctOnly:r=>`${r}% reduction from reuse`,untitled:"Untitled",sessionStarted:"Session started",previously:"Previously",footerAccess:(r,e)=>`Access ${r}k tokens of past research & decisions for just ${e}t. Use the claude-mem skill to access memories by ID.`,emptyState:"No previous sessions found for this project yet."}},ss="zh";function R(){return tt[ss]||tt.en}function st(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function rt(r){return["",`${c.bright}${c.cyan}[${r}] ${R().recentContext}, ${st()}${c.reset}`,`${c.gray}${"\u2500".repeat(60)}${c.reset}`,""]}function nt(){let e=I.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${c.dim}${R().legend}: ${R().legendSession} | ${e}${c.reset}`,""]}function ot(){return[`${c.bright}${R().columnKey}${c.reset}`,`${c.dim}  Read: ${R().colReadDesc}${c.reset}`,`${c.dim}  Work: ${R().colWorkDesc}${c.reset}`,""]}function it(){return[`${c.dim}${R().contextIndex}${c.reset}`,"",`${c.dim}${R().whenNeed}${c.reset}`,`${c.dim}  - ${R().fetchById}${c.reset}`,`${c.dim}  - ${R().searchHistory}${c.reset}`,`${c.dim}  - ${R().trustIndex}${c.reset}`,""]}function at(r,e){let t=[],s=R();if(t.push(`${c.bright}${c.cyan}${s.contextEconomics}${c.reset}`),t.push(`${c.dim}  ${s.loading(r.totalObservations,r.totalReadTokens.toLocaleString())}${c.reset}`),t.push(`${c.dim}  ${s.workInvest(r.totalDiscoveryTokens.toLocaleString())}${c.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let n=`  ${s.yourSavings}: `;e.showSavingsAmount&&e.showSavingsPercent?n+=s.tokensSavings(r.savings.toLocaleString(),r.savingsPercent):e.showSavingsAmount?n+=s.tokensOnly(r.savings.toLocaleString()):n+=s.pctOnly(r.savingsPercent),t.push(`${c.green}${n}${c.reset}`)}return t.push(""),t}function dt(r){return[`${c.bright}${c.cyan}${r}${c.reset}`,""]}function ct(r){return[`${c.dim}${r}${c.reset}`]}function _t(r,e,t,s){let n=r.title||R().untitled,o=I.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=P(r,s),m=t?`${c.dim}${e}${c.reset}`:" ".repeat(e.length),u=s.showReadTokens&&i>0?`${c.dim}(~${i}t)${c.reset}`:"",T=s.showWorkTokens&&a>0?`${c.dim}(${d} ${a.toLocaleString()}t)${c.reset}`:"";return`  ${c.dim}#${r.id}${c.reset}  ${m}  ${o}  ${n} ${u} ${T}`}function ut(r,e,t,s,n){let o=[],i=r.title||R().untitled,a=I.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:m,workEmoji:u}=P(r,n),T=t?`${c.dim}${e}${c.reset}`:" ".repeat(e.length),E=n.showReadTokens&&d>0?`${c.dim}(~${d}t)${c.reset}`:"",g=n.showWorkTokens&&m>0?`${c.dim}(${u} ${m.toLocaleString()}t)${c.reset}`:"";return o.push(`  ${c.dim}#${r.id}${c.reset}  ${T}  ${a}  ${c.bright}${i}${c.reset}`),s&&o.push(`    ${c.dim}${s}${c.reset}`),(E||g)&&o.push(`    ${E} ${g}`),o.push(""),o}function mt(r,e){let t=`${r.request||R().sessionStarted} (${e})`;return[`${c.yellow}#S${r.id}${c.reset} ${t}`,""]}function G(r,e,t){return e?[`${t}${r}:${c.reset} ${e}`,""]:[]}function lt(r){return r.assistantMessage?["","---","",`${c.bright}${c.magenta}${R().previously}${c.reset}`,"",`${c.dim}A: ${r.assistantMessage}${c.reset}`,""]:[]}function pt(r,e){let t=Math.round(r/1e3);return["",`${c.dim}${R().footerAccess(t,e.toLocaleString())}${c.reset}`]}function Et(r){return`
${c.bright}${c.cyan}[${r}] ${R().recentContext}, ${st()}${c.reset}
${c.gray}${"\u2500".repeat(60)}${c.reset}

${c.dim}${R().emptyState}${c.reset}
`}function gt(r,e,t,s){let n=[];return s?n.push(...rt(r)):n.push(...Xe(r)),s?n.push(...nt()):n.push(...je()),s?n.push(...ot()):n.push(...Be()),s?n.push(...it()):n.push(...We()),Y(t)&&(s?n.push(...at(e,t)):n.push(...qe(e,t))),n}var ge=x(require("path"),1);function Z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Te(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function fe(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function ft(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Tt(r,e){return ge.default.isAbsolute(r)?ge.default.relative(e,r):r}function St(r,e,t){let s=Z(r);if(s.length>0)return Tt(s[0],e);if(t){let n=Z(t);if(n.length>0)return Tt(n[0],e)}return"General"}function rs(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=ft(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function bt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Z(r.facts).join(`
`):null}function ns(r,e,t,s){let n=[];n.push(...Ve(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Te(a.displayTime);n.push(...Qe(a,d))}else{let a=i.data,d=fe(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let E=bt(a,s);n.push(...Je(a,u,E,s))}else n.push(Ye(a,u,s))}return n}function os(r,e,t,s,n){let o=[];o.push(...dt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let m=d.data,u=Te(m.displayTime);o.push(...mt(m,u))}else{let m=d.data,u=St(m.files_modified,n,m.files_read),T=fe(m.created_at),E=T!==a;a=T;let g=t.has(m.id);if(u!==i&&(o.push(...ct(u)),i=u),g){let S=bt(m,s);o.push(...ut(m,T,E,S,s))}else o.push(_t(m,T,E,s))}return o.push(""),o}function is(r,e,t,s,n,o){return o?os(r,e,t,s,n):ns(r,e,t,s)}function ht(r,e,t,s,n){let o=[],i=rs(r);for(let[a,d]of i)o.push(...is(a,d,e,t,s,n));return o}function Ot(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Rt(r,e){let t=[];return e?(t.push(...G("Investigated",r.investigated,c.blue)),t.push(...G("Learned",r.learned,c.yellow)),t.push(...G("Completed",r.completed,c.green)),t.push(...G("Next Steps",r.next_steps,c.magenta))):(t.push(...H("Investigated",r.investigated)),t.push(...H("Learned",r.learned)),t.push(...H("Completed",r.completed)),t.push(...H("Next Steps",r.next_steps))),t}function At(r,e){return e?lt(r):ze(r)}function Nt(r,e,t){return!Y(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?pt(r.totalDiscoveryTokens,r.totalReadTokens):Ze(r.totalDiscoveryTokens,r.totalReadTokens)}var as=It.default.join((0,Ct.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function ds(){try{return new q}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Lt.unlinkSync)(as)}catch(e){e instanceof Error?_.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):_.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return _.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function cs(r,e){return e?Et(r):et(r)}function _s(r,e,t,s,n,o,i){let a=[],d=ue(e);a.push(...gt(r,d,s,i));let m=t.slice(0,s.sessionCount),u=Pe(m,t),T=Ee(e,u),E=He(e,s.fullObservationCount);a.push(...ht(T,E,s,n,i));let g=t[0],S=e[0];Ot(s,g,S)&&a.push(...Rt(g,i));let b=pe(e,s,o,n);return a.push(...At(b,i)),a.push(...Nt(d,s,i)),a.join(`
`).trimEnd()}async function Se(r,e=!1){let t=de(),s=r?.cwd??process.cwd(),n=ne(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=ds();if(!a)return"";try{let d=o.length>1?$e(a,o,t):me(a,i,t),m=o.length>1?Fe(a,o,t):le(a,i,t);return d.length===0&&m.length===0?cs(i,e):_s(i,d,m,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
