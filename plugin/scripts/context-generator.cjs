"use strict";var Dt=Object.create;var G=Object.defineProperty;var yt=Object.getOwnPropertyDescriptor;var Mt=Object.getOwnPropertyNames;var Ut=Object.getPrototypeOf,xt=Object.prototype.hasOwnProperty;var wt=(r,e)=>{for(var t in e)G(r,t,{get:e[t],enumerable:!0})},Oe=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Mt(e))!xt.call(r,n)&&n!==t&&G(r,n,{get:()=>e[n],enumerable:!(s=yt(e,n))||s.enumerable});return r};var x=(r,e,t)=>(t=r!=null?Dt(Ut(r)):{},Oe(e||!r||!r.__esModule?G(t,"default",{value:r,enumerable:!0}):t,r)),Pt=r=>Oe(G({},"__esModule",{value:!0}),r);var ps={};wt(ps,{generateContext:()=>be});module.exports=Pt(ps);var Ct=x(require("path"),1),Lt=require("os"),vt=require("fs");var de=require("bun:sqlite");var h=require("path"),X=require("os"),D=require("fs");var Ae=require("url");var v=require("fs"),Ne=require("path");var te=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(te||{}),se=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=w.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ne.join)(e,`claude-mem-plus-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=w.settings();if((0,v.existsSync)(e)){let t=(0,v.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=te[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=te[e].padEnd(5),d=t.padEnd(6),_="";n?.correlationId?_=`[${n.correlationId}] `:n?.sessionId&&(_=`[session-${n.sessionId}] `);let p="";if(o!=null)if(o instanceof Error)p=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{p=`
`+JSON.stringify(o,null,2)}catch{p=" "+this.formatData(o)}else p=" "+this.formatData(o);let E="";if(n){let{sessionId:T,memorySessionId:f,correlationId:S,...l}=n;Object.keys(l).length>0&&(E=` {${Object.entries(l).map(([b,m])=>`${b}=${m}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${_}${s}${E}${p}`;if(this.logFilePath)try{(0,v.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),p=_?`${_[1].split("/").pop()}:${_[2]}`:"unknown",E={...s,location:p};return this.warn(e,`[HAPPY-PATH] ${t}`,E,n),o}},u=new se;var Yt={};function kt(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,Ae.fileURLToPath)(Yt.url))}var Ft=kt();function $t(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,h.join)((0,X.homedir)(),".claude-mem-plus"),e=(0,h.join)((0,X.homedir)(),".claude-mem");for(let t of[r,e]){let s=(0,h.join)(t,"settings.json");try{if((0,D.existsSync)(s)){let n=JSON.parse((0,D.readFileSync)(s,"utf-8")),o=n.env??n;return o.CLAUDE_MEM_DATA_DIR?o.CLAUDE_MEM_DATA_DIR:t}}catch{}}return r}var R=$t(),y=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,X.homedir)(),".claude"),hs=(0,h.join)(y,"plugins","marketplaces","bjarne56"),jt=(0,h.join)(R,"archives"),Ht=(0,h.join)(R,"logs"),Gt=(0,h.join)(R,"trash"),Xt=(0,h.join)(R,"backups"),Bt=(0,h.join)(R,"modes"),fs=(0,h.join)(R,"settings.json"),re=(0,h.join)(R,"claude-mem.db"),Wt=(0,h.join)(R,"vector-db"),Ie=(0,h.join)(R,"observer-sessions"),ne=(0,h.basename)(Ie),Ss=(0,h.join)(y,"settings.json"),bs=(0,h.join)(y,"commands"),Rs=(0,h.join)(y,"CLAUDE.md");function oe(r){(0,D.mkdirSync)(r,{recursive:!0})}function Ce(){return(0,h.join)(Ft,"..")}var w={dataDir:()=>R,workerPid:()=>(0,h.join)(R,"worker.pid"),settings:()=>(0,h.join)(R,"settings.json"),database:()=>(0,h.join)(R,"claude-mem.db"),chroma:()=>(0,h.join)(R,"chroma"),combinedCerts:()=>(0,h.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,h.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,h.join)(R,"transcript-watch-state.json"),corpora:()=>(0,h.join)(R,"corpora"),supervisorRegistry:()=>(0,h.join)(R,"supervisor.json"),envFile:()=>(0,h.join)(R,".env"),logsDir:()=>Ht,archives:()=>jt,trash:()=>Gt,backups:()=>Xt,modes:()=>Bt,vectorDb:()=>Wt,observerSessions:()=>Ie};var Ue=require("crypto");var ve=require("os"),De=x(require("path"),1);var W=require("fs"),B=x(require("path"),1),P={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Le(r){let e=B.default.join(r,".git"),t;try{t=(0,W.statSync)(e)}catch(p){return p instanceof Error&&p.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",p),P}if(!t.isFile())return P;let s;try{s=(0,W.readFileSync)(e,"utf-8").trim()}catch(p){return console.warn("[worktree] Failed to read .git file:",p instanceof Error?p.message:String(p)),P}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return P;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return P;let a=i[1],d=B.default.basename(r),_=B.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:_}}function ye(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,ve.homedir)()):r}function Me(r){if(!r||r.trim()==="")return u.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=ye(r),t=De.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return u.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return u.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function ie(r){let e=Me(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=ye(r),s=Le(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}var qt=require("bun:sqlite");function Y(r,e,t){return(0,Ue.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ae(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var A="claude";function Vt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function M(r){if(!r)return A;let e=Vt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:A}function xe(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Kt(r,e){return{customTitle:r,platformSource:e?M(e):void 0}}var q=class{db;constructor(e=re){e instanceof de.Database?this.db=e:(e!==":memory:"&&oe(R),this.db=new de.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addPendingMessagesToolUseIdAndWorkerPidColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.dropWorkerPidColumn(),this.ensureProjectsTables(),this.migrateProjectIdToInt()}migrateProjectIdToInt(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(34))return;if(this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='projects'").all().length===0){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(34,new Date().toISOString());return}let n=this.db.query("PRAGMA table_info(projects)").all().find(_=>_.name==="id");if(n&&n.type?.toUpperCase().startsWith("INTEGER")){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(34,new Date().toISOString());return}u.info("DB","[migration v34] \u9879\u76EE ID \u4ECE TEXT(p_xxx)\u8FC1\u5230 INTEGER(8 \u4F4D\u6570\u5B57)\u5F00\u59CB");let o=1e7,i=99999999,a=new Set,d=()=>{for(let _=0;_<1e3;_++){let p=Math.floor(o+Math.random()*(i-o+1));if(!a.has(p))return a.add(p),p}throw new Error("Failed to allocate 8-digit project ID after 1000 retries")};this.db.transaction(()=>{this.db.run(`CREATE TEMP TABLE _project_id_map (
        old_id TEXT PRIMARY KEY,
        new_id INTEGER NOT NULL UNIQUE
      )`);let _=this.db.prepare("SELECT id FROM projects").all(),p=this.db.prepare("INSERT INTO _project_id_map (old_id, new_id) VALUES (?, ?)");for(let S of _)p.run(S.id,d());this.db.run(`CREATE TABLE projects_new (
        ...
        last_seen_at INTEGER NOT NULL
                   ...
                   FROM project_paths pp JOIN _project_id_map m ON m.old_id = pp.project_id`);let E=S=>{let l=this.db.query(`PRAGMA table_info(${S})`).all();return l.length===0||!l.some(b=>b.name==="project_id")?0:this.db.prepare(`
          UPDATE ${S} SET project_id = (SELECT new_id FROM _project_id_map WHERE old_id = ${S}.project_id)
          WHERE project_id IS NOT NULL AND project_id IN (SELECT old_id FROM _project_id_map)
        `).run().changes},g=E("observations"),T=E("session_summaries"),f=E("sdk_sessions");this.db.run("DROP TABLE project_paths"),this.db.run("DROP TABLE projects"),this.db.run("ALTER TABLE projects_new RENAME TO projects"),this.db.run("ALTER TABLE project_paths_new RENAME TO project_paths"),this.db.run("CREATE INDEX IF NOT EXISTS idx_projects_name ON projects(name)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_project_paths_project ON project_paths(project_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_project_paths_path ON project_paths(path)"),this.db.run("DROP TABLE _project_id_map"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(34,new Date().toISOString()),u.info("DB",`[migration v34] \u5B8C\u6210: ${_.length} projects \u91CD ID,\u5F15\u7528\u66F4\u65B0 obs=${g} sum=${T} sess=${f}`)})()}ensureProjectsTables(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(33))return;this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,_=s==="relevance",p=_?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,E=n?`LIMIT ${n}`:"",g=e.map(()=>"?").join(","),T=[...e],f=[];if(o&&(f.push("project = ?"),T.push(o)),i)if(Array.isArray(i)){let m=i.map(()=>"?").join(",");f.push(`type IN (${m})`),T.push(...i)}else f.push("type = ?"),T.push(i);if(a){let m=Array.isArray(a)?a:[a],L=m.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");T.push(...m),f.push(`(${L.join(" OR ")})`)}if(d){let m=Array.isArray(d)?d:[d],L=m.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");m.forEach(U=>{T.push(`%${U}%`,`%${U}%`)}),f.push(`(${L.join(" OR ")})`)}let S=f.length>0?`WHERE id IN (${g}) AND ${f.join(" AND ")}`:`WHERE id IN (${g})`,N=this.db.prepare(`
      SELECT *
      FROM observations
      ${S}
      ${p}
      ${E}
    `).all(...T);if(!_)return N;let b=new Map(N.map(m=>[m.id,m]));return e.map(m=>b.get(m)).filter(m=>!!m)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Kt(n,o),_=d.platformSource??A,p=this.db.prepare(`
    ...
    `).get(e);if(p){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let g=p.platform_source?.trim()?M(p.platform_source):void 0;if(!g)this.db.prepare(`
            UPDATE sdk_sessions SET platform_source = ?
            WHERE content_session_id = ?
              AND COALESCE(platform_source, '') = ''
          `).run(d.platformSource,e);else if(g!==d.platformSource)throw new Error(`Platform source conflict for session ${e}: existing=${g}, received=${d.platformSource}`)}return p.id}return this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),_=new Date(d).toISOString(),p=Y(e,s.title,s.narrative),g=this.db.prepare(`
    ...
    `).get(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,p,_,d,a||null,s.metadata??null);if(g)return{id:g.id,createdAtEpoch:g.created_at_epoch};let T=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,p);if(!T)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${p}`);return{id:T.id,createdAtEpoch:T.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),p=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(p.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let _=a??Date.now(),p=new Date(_).toISOString();return this.db.transaction(()=>{let g=[],T=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),f=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let l of s){let N=Y(e,l.title,l.narrative),b=T.get(e,t,l.type,l.title,l.subtitle,JSON.stringify(l.facts),l.narrative,JSON.stringify(l.concepts),JSON.stringify(l.files_read),JSON.stringify(l.files_modified),o||null,i,l.agent_type??null,l.agent_id??null,N,p,_,d||null);if(b){g.push(b.id);continue}let m=f.get(e,N);if(!m)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${N}`);g.push(m.id)}let S=null;if(n){let N=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,p,_);S=Number(N.lastInsertRowid)}return{observationIds:g,summaryId:S,createdAtEpoch:_}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,_,p){let E=_??Date.now(),g=new Date(E).toISOString();return this.db.transaction(()=>{let f=[],S=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),l=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let m of s){let L=Y(e,m.title,m.narrative),U=S.get(e,t,m.type,m.title,m.subtitle,JSON.stringify(m.facts),m.narrative,JSON.stringify(m.concepts),JSON.stringify(m.files_read),JSON.stringify(m.files_modified),a||null,d,m.agent_type??null,m.agent_id??null,L,g,E,p||null);if(U){f.push(U.id);continue}let Re=l.get(e,L);if(!Re)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${L}`);f.push(Re.id)}let N;if(n){let L=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,g,E);N=Number(L.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(E,o),{observationIds:f,summaryId:N,createdAtEpoch:E}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",_=e.map(()=>"?").join(","),p=[...e],E=o?`WHERE id IN (${_}) AND project = ?`:`WHERE id IN (${_})`;o&&p.push(o);let T=this.db.prepare(`
      SELECT * FROM session_summaries
      ${E}
      ${a}
      ${d}
    `).all(...p);if(!i)return T;let f=new Map(T.map(S=>[S.id,S]));return e.map(S=>f.get(S)).filter(S=>!!S)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",_=e.map(()=>"?").join(","),p=[...e],E=o?"AND s.project = ?":"";o&&p.push(o);let T=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(...p);if(!i)return T;let f=new Map(T.map(S=>[S.id,S]));return e.map(S=>f.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,_;if(e!==null){let l=`
      ...
      `,N=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let b=this.db.prepare(l).all(t,...a,s),m=this.db.prepare(N).all(t,...a,n+1);if(b.length===0&&m.length===0)return{observations:[],sessions:[],prompts:[]};d=b.length>0?b[b.length-1].created_at_epoch:t,_=m.length>0?m[m.length-1].created_at_epoch:t}catch(b){return b instanceof Error?u.error("DB","Error getting boundary timestamps",{project:o},b):u.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(b))),{observations:[],sessions:[],prompts:[]}}}let p=`
      SELECT *
      FROM observations
  ...
  `).all(e,e,...s,...o,t.totalObservationCount)}function Ee(r,e,t){return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+_e)}function Fe(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
  ...
  `).all(...e,...e,...s,...o,t.totalObservationCount)}function $e(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t.sessionCount+_e)}function Zt(r){return r.replace(/\//g,"-")}function es(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(Pe,"").trim(),t)return t}return null}function ts(r){for(let e=r.length-1;e>=0;e--)try{let t=es(r[e]);if(t)return t}catch(t){t instanceof Error?u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function ss(r){try{if(!(0,Q.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,Q.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{userMessage:"",assistantMessage:ts(t)}}catch(e){return e instanceof Error?u.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):u.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{userMessage:"",assistantMessage:""}}}function ge(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=Zt(s),a=ke.default.join(y,"projects",i,`${o}.jsonl`);return ss(a)}function je(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Te(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function He(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function Ge(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Xe(r){return[`# [${r}] recent context, ${Ge()}`,""]}function Be(){return[`Legend: \u{1F3AF}session ${I.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function We(){return[]}function Ye(){return[]}function qe(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function Ve(r){return[`### ${r}`]}function Ke(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function Je(r,e,t){let s=r.title||"Untitled",n=I.getInstance().getTypeIcon(r.type),o=e?Ke(e):'"';return`${r.id} ${o} ${n} ${s}`}function Qe(r,e,t,s){let n=[],o=r.title||"Untitled",i=I.getInstance().getTypeIcon(r.type),a=e?Ke(e):'"',{readTokens:d,discoveryDisplay:_}=$(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let p=[];return s.showReadTokens&&p.push(`~${d}t`),s.showWorkTokens&&p.push(_),p.length>0&&n.push(p.join(" ")),n.push(""),n}function ze(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function j(r,e){return e?[`**${r}**: ${e}`,""]:[]}function Ze(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function et(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function tt(r){return`# [${r}] recent context, ${Ge()}

No previous sessions found.`}var st={zh:{recentContext:"\u6700\u8FD1\u4E0A\u4E0B\u6587",legend:"\u56FE\u4F8B",legendSession:"\u4F1A\u8BDD\u8BF7\u6C42",columnKey:"\u5217\u8BF4\u660E",colReadDesc:"\u9605\u8BFB\u8FD9\u6761 observation \u7684\u8BCD\u5143\u6570(\u73B0\u5728\u5B66\u7684\u6210\u672C)",colWorkDesc:"\u4EA7\u51FA\u8FD9\u6761\u8BB0\u5F55\u82B1\u7684\u5DE5\u4F5C\u8BCD\u5143(\u8C03\u7814 / \u6784\u5EFA / \u51B3\u7B56)",contextIndex:"\u4E0A\u4E0B\u6587\u7D22\u5F15: \u8FD9\u4EFD\u8BED\u4E49\u7D22\u5F15(\u6807\u9898 / \u7C7B\u578B / \u6587\u4EF6 / \u8BCD\u5143)\u901A\u5E38\u8DB3\u4EE5\u7406\u89E3\u8FC7\u5F80\u5DE5\u4F5C\u3002",whenNeed:"\u5F53\u4F60\u9700\u8981\u5B9E\u73B0\u7EC6\u8282\u3001\u539F\u56E0\u6216\u8C03\u8BD5\u4E0A\u4E0B\u6587\u65F6:",fetchById:"\u6309 ID \u53D6: get_observations([IDs]) \u62C9\u53D6\u672C\u7D22\u5F15\u53EF\u89C1\u7684 observation",searchHistory:"\u641C\u5386\u53F2: \u7528 mem-search skill \u67E5\u8FC7\u5F80\u51B3\u7B56\u3001bug \u4E0E\u6DF1\u5EA6\u8C03\u7814",trustIndex:"\u4FE1\u4EFB\u672C\u7D22\u5F15,\u4E0D\u5FC5\u4E3A\u67E5\u8FC7\u5F80\u51B3\u7B56\u548C\u5B66\u5230\u7684\u5185\u5BB9\u91CD\u65B0\u8BFB\u4EE3\u7801",contextEconomics:"\u4E0A\u4E0B\u6587\u7ECF\u6D4E",loading:(r,e)=>`\u8F7D\u5165: ${r} \u6761 observation (${e} \u8BCD\u5143\u5F85\u8BFB)`,workInvest:r=>`\u5DE5\u4F5C\u6295\u5165: ${r} \u8BCD\u5143\u7528\u4E8E\u8C03\u7814\u3001\u6784\u5EFA\u4E0E\u51B3\u7B56`,yourSavings:"\u4F60\u8282\u7701",tokensSavings:(r,e)=>`${r} \u8BCD\u5143(\u590D\u7528\u51CF\u5C11 ${e}%)`,tokensOnly:r=>`${r} \u8BCD\u5143`,pctOnly:r=>`\u590D\u7528\u51CF\u5C11 ${r}%`,untitled:"\u672A\u547D\u540D",sessionStarted:"\u4F1A\u8BDD\u5F00\u59CB",previously:"\u4E4B\u524D",footerAccess:(r,e)=>`\u7528 ${e}t \u8BCD\u5143\u8BBF\u95EE\u8FC7\u5F80 ${r}k \u8BCD\u5143\u7684\u8C03\u7814\u4E0E\u51B3\u7B56\u3002\u7528 claude-mem-plus skill \u6309 ID \u53D6\u8BB0\u5FC6\u3002`,emptyState:"\u672C\u9879\u76EE\u6682\u65E0\u8FC7\u5F80\u4F1A\u8BDD\u3002"},en:{recentContext:"recent context",legend:"Legend",legendSession:"session-request",columnKey:"Column Key",colReadDesc:"Tokens to read this observation (cost to learn it now)",colWorkDesc:"Tokens spent on work that produced this record (research, building, deciding)",contextIndex:"Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.",whenNeed:"When you need implementation details, rationale, or debugging context:",fetchById:"Fetch by ID: get_observations([IDs]) for observations visible in this index",searchHistory:"Search history: Use the mem-search skill for past decisions, bugs, and deeper research",trustIndex:"Trust this index over re-reading code for past decisions and learnings",contextEconomics:"Context Economics",loading:(r,e)=>`Loading: ${r} observations (${e} tokens to read)`,workInvest:r=>`Work investment: ${r} tokens spent on research, building, and decisions`,yourSavings:"Your savings",tokensSavings:(r,e)=>`${r} tokens (${e}% reduction from reuse)`,tokensOnly:r=>`${r} tokens`,pctOnly:r=>`${r}% reduction from reuse`,untitled:"Untitled",sessionStarted:"Session started",previously:"Previously",footerAccess:(r,e)=>`Access ${r}k tokens of past research & decisions for just ${e}t. Use the claude-mem-plus skill to access memories by ID.`,emptyState:"No previous sessions found for this project yet."}},rs="zh";function O(){return st[rs]||st.en}function rt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function nt(r){return["",`${c.bright}${c.cyan}[${r}] ${O().recentContext}, ${rt()}${c.reset}`,`${c.gray}${"\u2500".repeat(60)}${c.reset}`,""]}function ot(){let e=I.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${c.dim}${O().legend}: ${O().legendSession} | ${e}${c.reset}`,""]}function it(){return[`${c.bright}${O().columnKey}${c.reset}`,`${c.dim}  Read: ${O().colReadDesc}${c.reset}`,`${c.dim}  Work: ${O().colWorkDesc}${c.reset}`,""]}function at(){return[`${c.dim}${O().contextIndex}${c.reset}`,"",`${c.dim}${O().whenNeed}${c.reset}`,`${c.dim}  - ${O().fetchById}${c.reset}`,`${c.dim}  - ${O().searchHistory}${c.reset}`,`${c.dim}  - ${O().trustIndex}${c.reset}`,""]}function dt(r,e){let t=[],s=O();if(t.push(`${c.bright}${c.cyan}${s.contextEconomics}${c.reset}`),t.push(`${c.dim}  ${s.loading(r.totalObservations,r.totalReadTokens.toLocaleString())}${c.reset}`),t.push(`${c.dim}  ${s.workInvest(r.totalDiscoveryTokens.toLocaleString())}${c.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let n=`  ${s.yourSavings}: `;e.showSavingsAmount&&e.showSavingsPercent?n+=s.tokensSavings(r.savings.toLocaleString(),r.savingsPercent):e.showSavingsAmount?n+=s.tokensOnly(r.savings.toLocaleString()):n+=s.pctOnly(r.savingsPercent),t.push(`${c.green}${n}${c.reset}`)}return t.push(""),t}function ct(r){return[`${c.bright}${c.cyan}${r}${c.reset}`,""]}function ut(r){return[`${c.dim}${r}${c.reset}`]}function _t(r,e,t,s){let n=r.title||O().untitled,o=I.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=$(r,s),_=t?`${c.dim}${e}${c.reset}`:" ".repeat(e.length),p=s.showReadTokens&&i>0?`${c.dim}(~${i}t)${c.reset}`:"",E=s.showWorkTokens&&a>0?`${c.dim}(${d} ${a.toLocaleString()}t)${c.reset}`:"";return`  ${c.dim}#${r.id}${c.reset}  ${_}  ${o}  ${n} ${p} ${E}`}function pt(r,e,t,s,n){let o=[],i=r.title||O().untitled,a=I.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:_,workEmoji:p}=$(r,n),E=t?`${c.dim}${e}${c.reset}`:" ".repeat(e.length),g=n.showReadTokens&&d>0?`${c.dim}(~${d}t)${c.reset}`:"",T=n.showWorkTokens&&_>0?`${c.dim}(${p} ${_.toLocaleString()}t)${c.reset}`:"";return o.push(`  ${c.dim}#${r.id}${c.reset}  ${E}  ${a}  ${c.bright}${i}${c.reset}`),s&&o.push(`    ${c.dim}${s}${c.reset}`),(g||T)&&o.push(`    ${g} ${T}`),o.push(""),o}function lt(r,e){let t=`${r.request||O().sessionStarted} (${e})`;return[`${c.yellow}#S${r.id}${c.reset} ${t}`,""]}function H(r,e,t){return e?[`${t}${r}:${c.reset} ${e}`,""]:[]}function mt(r){return r.assistantMessage?["","---","",`${c.bright}${c.magenta}${O().previously}${c.reset}`,"",`${c.dim}A: ${r.assistantMessage}${c.reset}`,""]:[]}function Et(r,e){let t=Math.round(r/1e3);return["",`${c.dim}${O().footerAccess(t,e.toLocaleString())}${c.reset}`]}function gt(r){return`
${c.bright}${c.cyan}[${r}] ${O().recentContext}, ${rt()}${c.reset}
${c.gray}${"\u2500".repeat(60)}${c.reset}

${c.dim}${O().emptyState}${c.reset}
`}function Tt(r,e,t,s){let n=[];return s?n.push(...nt(r)):n.push(...Xe(r)),s?n.push(...ot()):n.push(...Be()),s?n.push(...it()):n.push(...We()),s?n.push(...at()):n.push(...Ye()),J(t)&&(s?n.push(...dt(e,t)):n.push(...qe(e,t))),n}var he=x(require("path"),1);function ee(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function fe(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Se(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function ft(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ht(r,e){return he.default.isAbsolute(r)?he.default.relative(e,r):r}function St(r,e,t){let s=ee(r);if(s.length>0)return ht(s[0],e);if(t){let n=ee(t);if(n.length>0)return ht(n[0],e)}return"General"}function ns(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=ft(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function bt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?ee(r.facts).join(`
`):null}function os(r,e,t,s){let n=[];n.push(...Ve(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=fe(a.displayTime);n.push(...ze(a,d))}else{let a=i.data,d=Se(a.created_at),p=d!==o?d:"";if(o=d,t.has(a.id)){let g=bt(a,s);n.push(...Qe(a,p,g,s))}else n.push(Je(a,p,s))}return n}function is(r,e,t,s,n){let o=[];o.push(...ct(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,p=fe(_.displayTime);o.push(...lt(_,p))}else{let _=d.data,p=St(_.files_modified,n,_.files_read),E=Se(_.created_at),g=E!==a;a=E;let T=t.has(_.id);if(p!==i&&(o.push(...ut(p)),i=p),T){let f=bt(_,s);o.push(...pt(_,E,g,f,s))}else o.push(_t(_,E,g,s))}return o.push(""),o}function as(r,e,t,s,n,o){return o?is(r,e,t,s,n):os(r,e,t,s)}function Rt(r,e,t,s,n){let o=[],i=ns(r);for(let[a,d]of i)o.push(...as(a,d,e,t,s,n));return o}function Ot(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Nt(r,e){let t=[];return e?(t.push(...H("Investigated",r.investigated,c.blue)),t.push(...H("Learned",r.learned,c.yellow)),t.push(...H("Completed",r.completed,c.green)),t.push(...H("Next Steps",r.next_steps,c.magenta))):(t.push(...j("Investigated",r.investigated)),t.push(...j("Learned",r.learned)),t.push(...j("Completed",r.completed)),t.push(...j("Next Steps",r.next_steps))),t}function At(r,e){return e?mt(r):Ze(r)}function It(r,e,t){return!J(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Et(r.totalDiscoveryTokens,r.totalReadTokens):et(r.totalDiscoveryTokens,r.totalReadTokens)}var ds=Ct.default.join((0,Lt.homedir)(),".claude","plugins","marketplaces","bjarne56","plugin",".install-version");function cs(){try{return new q}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,vt.unlinkSync)(ds)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function us(r,e){return e?gt(r):tt(r)}function _s(r,e,t,s,n,o,i){let a=[],d=le(e);a.push(...Tt(r,d,s,i));let _=t.slice(0,s.sessionCount),p=je(_,t),E=Te(e,p),g=He(e,s.fullObservationCount);a.push(...Rt(E,g,s,n,i));let T=t[0],f=e[0];Ot(s,T,f)&&a.push(...Nt(T,i));let S=ge(e,s,o,n);return a.push(...At(S,i)),a.push(...It(d,s,i)),a.join(`
`).trimEnd()}async function be(r,e=!1){let t=ue(),s=r?.cwd??process.cwd(),n=ie(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=cs();if(!a)return"";try{let d=o.length>1?Fe(a,o,t):me(a,i,t),_=o.length>1?$e(a,o,t):Ee(a,i,t);return d.length===0&&_.length===0?us(i,e):_s(i,d,_,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
