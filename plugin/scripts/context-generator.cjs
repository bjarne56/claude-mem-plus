"use strict";var Dt=Object.create;var X=Object.defineProperty;var Mt=Object.getOwnPropertyDescriptor;var Ut=Object.getOwnPropertyNames;var xt=Object.getPrototypeOf,wt=Object.prototype.hasOwnProperty;var $t=(r,e)=>{for(var t in e)X(r,t,{get:e[t],enumerable:!0})},Ne=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ut(e))!wt.call(r,n)&&n!==t&&X(r,n,{get:()=>e[n],enumerable:!(s=Mt(e,n))||s.enumerable});return r};var x=(r,e,t)=>(t=r!=null?Dt(xt(r)):{},Ne(e||!r||!r.__esModule?X(t,"default",{value:r,enumerable:!0}):t,r)),Pt=r=>Ne(X({},"__esModule",{value:!0}),r);var ms={};$t(ms,{generateContext:()=>be});module.exports=Pt(ms);var Lt=x(require("path"),1),vt=require("os"),yt=require("fs");var ce=require("bun:sqlite");var T=require("path"),B=require("os"),D=require("fs");var Ie=require("url");var v=require("fs"),Ae=require("path");var se=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(se||{}),re=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=w.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ae.join)(e,`claude-mem-plus-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=w.settings();if((0,v.existsSync)(e)){let t=(0,v.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=se[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",m={...s,location:_};return this.warn(e,`[HAPPY-PATH] ${t}`,m,n),o}},u=new re;var Yt={};function kt(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,Ie.fileURLToPath)(Yt.url))}var Ft=kt();function jt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,T.join)((0,B.homedir)(),".claude-mem-plus"),e=(0,T.join)((0,B.homedir)(),".claude-mem");for(let t of[r,e]){let s=(0,T.join)(t,"settings.json");try{if((0,D.existsSync)(s)){let n=JSON.parse((0,D.readFileSync)(s,"utf-8")),o=n.env??n;return o.CLAUDE_MEM_DATA_DIR?o.CLAUDE_MEM_DATA_DIR:t}}catch{}}return r}var R=jt(),M=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,B.homedir)(),".claude"),Ss=(0,T.join)(M,"plugins","marketplaces","bjarne56"),Ht=(0,T.join)(R,"archives"),Gt=(0,T.join)(R,"logs"),Xt=(0,T.join)(R,"trash"),Bt=(0,T.join)(R,"backups"),Wt=(0,T.join)(R,"modes"),bs=(0,T.join)(R,"settings.json"),ne=(0,T.join)(R,"claude-mem.db"),Vt=(0,T.join)(R,"vector-db"),Ce=(0,T.join)(R,"observer-sessions"),oe=(0,T.basename)(Ce),Rs=(0,T.join)(M,"settings.json"),Os=(0,T.join)(M,"commands"),Ns=(0,T.join)(M,"CLAUDE.md");function ie(r){(0,D.mkdirSync)(r,{recursive:!0})}function Le(){return(0,T.join)(Ft,"..")}var w={dataDir:()=>R,workerPid:()=>(0,T.join)(R,"worker.pid"),settings:()=>(0,T.join)(R,"settings.json"),database:()=>(0,T.join)(R,"claude-mem.db"),chroma:()=>(0,T.join)(R,"chroma"),combinedCerts:()=>(0,T.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(R,"transcript-watch-state.json"),corpora:()=>(0,T.join)(R,"corpora"),supervisorRegistry:()=>(0,T.join)(R,"supervisor.json"),envFile:()=>(0,T.join)(R,".env"),logsDir:()=>Gt,archives:()=>Ht,trash:()=>Xt,backups:()=>Bt,modes:()=>Wt,vectorDb:()=>Vt,observerSessions:()=>Ce};var xe=require("crypto");var ye=require("os"),De=x(require("path"),1);var V=require("fs"),W=x(require("path"),1),$={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function ve(r){let e=W.default.join(r,".git"),t;try{t=(0,V.statSync)(e)}catch(_){return _ instanceof Error&&_.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",_),$}if(!t.isFile())return $;let s;try{s=(0,V.readFileSync)(e,"utf-8").trim()}catch(_){return console.warn("[worktree] Failed to read .git file:",_ instanceof Error?_.message:String(_)),$}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return $;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return $;let a=i[1],d=W.default.basename(r),p=W.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:p}}function Me(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,ye.homedir)()):r}function Ue(r){if(!r||r.trim()==="")return u.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=Me(r),t=De.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return u.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return u.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function ae(r){let e=Ue(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=Me(r),s=ve(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}var qt=require("bun:sqlite");function Y(r,e,t){return(0,xe.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function de(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var I="claude";function Kt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function U(r){if(!r)return I;let e=Kt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:I}function we(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Jt(r,e){return{customTitle:r,platformSource:e?U(e):void 0}}var q=class{db;constructor(e=ne){e instanceof ce.Database?this.db=e:(e!==":memory:"&&ie(R),this.db=new ce.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureProjectsTables(),this.migrateProjectIdToInt()}migrateProjectIdToInt(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(34))return;if(this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='projects'").all().length===0){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(34,new Date().toISOString());return}let n=this.db.query("PRAGMA table_info(projects)").all().find(p=>p.name==="id");if(n&&n.type?.toUpperCase().startsWith("INTEGER")){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(34,new Date().toISOString());return}u.info("DB","[migration v34] \u9879\u76EE ID \u4ECE TEXT(p_xxx)\u8FC1\u5230 INTEGER(8 \u4F4D\u6570\u5B57)\u5F00\u59CB");let o=1e7,i=99999999,a=new Set,d=()=>{for(let p=0;p<1e3;p++){let _=Math.floor(o+Math.random()*(i-o+1));if(!a.has(_))return a.add(_),_}throw new Error("Failed to allocate 8-digit project ID after 1000 retries")};this.db.transaction(()=>{this.db.run(`CREATE TEMP TABLE _project_id_map (
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),p=new Date(d).toISOString(),_=Y(e,s.title,s.narrative),E=this.db.prepare(`
...
`}function os(r,e,t){if(!r&&!e)return[];let s=r?.created_at_epoch??0,n=e?.created_at_epoch??0,o=s>=n,i=o?`#${r.id}`:`#S${e.id}`,a=o?r.created_at:e.created_at,d=j(a);return t?[`${c.dim}\u{1F4CC} latest: ${i} (${d})${c.reset}`,""]:[`Latest: ${i} (${d})`,""]}function bt(r,e,t,s,n,o){let i=[];return s?i.push(...dt(r)):i.push(...Ye(r)),i.push(...os(n,o,s)),s?i.push(...ct()):i.push(...qe()),s?i.push(...ut()):i.push(...Ke()),s?i.push(...pt()):i.push(...Je()),Q(t)&&(s?i.push(..._t(e,t)):i.push(...Qe(e,t))),i}function is(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Be(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}for(let[,s]of e)s.sort((n,o)=>{let i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return(o.type==="observation"?o.data.created_at_epoch:o.data.displayEpoch)-i});let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime();return new Date(n[0]).getTime()-o});return new Map(t)}function Rt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Z(r.facts).join(`
`):null}function as(r,e,t,s){let n=[];n.push(...ze(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=j(a.displayTime);n.push(...st(a,d))}else{let a=i.data,d=Se(a.created_at),_=d!==o?d:"";if(o=d,t.has(a.id)){let E=Rt(a,s);n.push(...tt(a,_,E,s))}else n.push(et(a,_,s))}return n}function ds(r,e,t,s,n){let o=[];o.push(...lt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let p=d.data,_=j(p.displayTime);o.push(...Tt(p,_))}else{let p=d.data,_=We(p.files_modified,n,p.files_read),m=Se(p.created_at),E=m!==a;a=m;let g=t.has(p.id);if(_!==i&&(o.push(...mt(_)),i=_),g){let h=Rt(p,s);o.push(...gt(p,m,E,h,s))}else o.push(Et(p,m,E,s))}return o.push(""),o}function cs(r,e,t,s,n,o){return o?ds(r,e,t,s,n):as(r,e,t,s)}function Ot(r,e,t,s,n){let o=[],i=is(r);for(let[a,d]of i)o.push(...cs(a,d,e,t,s,n));return o}function Nt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function At(r,e){let t=[];return e?(t.push(...G("Investigated",r.investigated,c.blue)),t.push(...G("Learned",r.learned,c.yellow)),t.push(...G("Completed",r.completed,c.green)),t.push(...G("Next Steps",r.next_steps,c.magenta))):(t.push(...H("Investigated",r.investigated)),t.push(...H("Learned",r.learned)),t.push(...H("Completed",r.completed)),t.push(...H("Next Steps",r.next_steps))),t}function It(r,e){return e?ht(r):rt(r)}function Ct(r,e,t){return!Q(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?ft(r.totalDiscoveryTokens,r.totalReadTokens):nt(r.totalDiscoveryTokens,r.totalReadTokens)}var us=Lt.default.join((0,vt.homedir)(),".claude","plugins","marketplaces","bjarne56","plugin",".install-version");function ps(){try{return new q}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,yt.unlinkSync)(us)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function _s(r,e){return e?St(r):ot(r)}function ls(r,e,t,s,n,o,i){let a=[],d=me(e);a.push(...bt(r,d,s,i,e[0],t[0]));let p=t.slice(0,s.sessionCount),_=He(p,t),m=he(e,_),E=Ge(e,s.fullObservationCount);a.push(...Ot(m,E,s,n,i));let g=t[0],h=e[0];Nt(s,g,h)&&a.push(...At(g,i));let f=Te(e,s,o,n);return a.push(...It(f,i)),a.push(...Ct(d,s,i)),a.join(`
`).trimEnd()}async function be(r,e=!1){let t=pe(),s=r?.cwd??process.cwd(),n=ae(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=ps();if(!a)return"";try{let d=o.length>1?Fe(a,o,t):Ee(a,i,t),p=o.length>1?je(a,o,t):ge(a,i,t);return d.length===0&&p.length===0?_s(i,e):ls(i,d,p,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
