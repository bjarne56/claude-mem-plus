"use strict";var yt=Object.create;var j=Object.defineProperty;var vt=Object.getOwnPropertyDescriptor;var Dt=Object.getOwnPropertyNames;var Mt=Object.getPrototypeOf,Ut=Object.prototype.hasOwnProperty;var xt=(r,e)=>{for(var t in e)j(r,t,{get:e[t],enumerable:!0})},he=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Dt(e))!Ut.call(r,n)&&n!==t&&j(r,n,{get:()=>e[n],enumerable:!(s=vt(e,n))||s.enumerable});return r};var x=(r,e,t)=>(t=r!=null?yt(Mt(r)):{},he(e||!r||!r.__esModule?j(t,"default",{value:r,enumerable:!0}):t,r)),wt=r=>he(j({},"__esModule",{value:!0}),r);var _s={};xt(_s,{generateContext:()=>Se});module.exports=wt(_s);var It=x(require("path"),1),Ct=require("os"),Lt=require("fs");var ie=require("bun:sqlite");var f=require("path"),X=require("os"),v=require("fs");var Re=require("url");var y=require("fs"),Oe=require("path");var te=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(te||{}),se=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=w.logsDir();(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Oe.join)(e,`claude-mem-plus-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=w.settings();if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=te[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=te[e].padEnd(5),d=t.padEnd(6),m="";n?.correlationId?m=`[${n.correlationId}] `:n?.sessionId&&(m=`[session-${n.sessionId}] `);let _="";if(o!=null)if(o instanceof Error)_=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{_=`
`+JSON.stringify(o,null,2)}catch{_=" "+this.formatData(o)}else _=" "+this.formatData(o);let T="";if(n){let{sessionId:g,memorySessionId:S,correlationId:b,...p}=n;Object.keys(p).length>0&&(T=` {${Object.entries(p).map(([h,l])=>`${h}=${l}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${m}${s}${T}${_}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,E+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=m?`${m[1].split("/").pop()}:${m[2]}`:"unknown",T={...s,location:_};return this.warn(e,`[HAPPY-PATH] ${t}`,T,n),o}},c=new se;var Wt={};function kt(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Re.fileURLToPath)(Wt.url))}var $t=kt();function Ft(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,X.homedir)(),".claude-mem-plus"),e=(0,f.join)((0,X.homedir)(),".claude-mem");for(let t of[r,e]){let s=(0,f.join)(t,"settings.json");try{if((0,v.existsSync)(s)){let n=JSON.parse((0,v.readFileSync)(s,"utf-8")),o=n.env??n;return o.CLAUDE_MEM_DATA_DIR?o.CLAUDE_MEM_DATA_DIR:t}}catch{}}return r}var O=Ft(),D=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,X.homedir)(),".claude"),Ts=(0,f.join)(D,"plugins","marketplaces","bjarne56"),Pt=(0,f.join)(O,"archives"),Ht=(0,f.join)(O,"logs"),Gt=(0,f.join)(O,"trash"),jt=(0,f.join)(O,"backups"),Xt=(0,f.join)(O,"modes"),fs=(0,f.join)(O,"settings.json"),Ae=(0,f.join)(O,"claude-mem.db"),Bt=(0,f.join)(O,"vector-db"),Ne=(0,f.join)(O,"observer-sessions"),re=(0,f.basename)(Ne),Ss=(0,f.join)(D,"settings.json"),bs=(0,f.join)(D,"commands"),hs=(0,f.join)(D,"CLAUDE.md");function Ie(r){(0,v.mkdirSync)(r,{recursive:!0})}function Ce(){return(0,f.join)($t,"..")}var w={dataDir:()=>O,workerPid:()=>(0,f.join)(O,"worker.pid"),settings:()=>(0,f.join)(O,"settings.json"),database:()=>(0,f.join)(O,"claude-mem.db"),chroma:()=>(0,f.join)(O,"chroma"),combinedCerts:()=>(0,f.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,f.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,f.join)(O,"transcript-watch-state.json"),corpora:()=>(0,f.join)(O,"corpora"),supervisorRegistry:()=>(0,f.join)(O,"supervisor.json"),envFile:()=>(0,f.join)(O,".env"),logsDir:()=>Ht,archives:()=>Pt,trash:()=>Gt,backups:()=>jt,modes:()=>Xt,vectorDb:()=>Bt,observerSessions:()=>Ne};var Me=require("crypto");var ye=require("os"),ve=x(require("path"),1);var W=require("fs"),B=x(require("path"),1),k={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Le(r){let e=B.default.join(r,".git"),t;try{t=(0,W.statSync)(e)}catch(_){return _ instanceof Error&&_.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",_),k}if(!t.isFile())return k;let s;try{s=(0,W.readFileSync)(e,"utf-8").trim()}catch(_){return console.warn("[worktree] Failed to read .git file:",_ instanceof Error?_.message:String(_)),k}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return k;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return k;let a=i[1],d=B.default.basename(r),m=B.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:m}}function De(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,ye.homedir)()):r}function qt(r){if(!r||r.trim()==="")return c.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=De(r),t=ve.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return c.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return c.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function ne(r){let e=qt(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=De(r),s=Le(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function q(r,e,t){return(0,Me.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function oe(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var N="claude";function Vt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function M(r){if(!r)return N;let e=Vt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:N}function Ue(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Kt(r,e){return{customTitle:r,platformSource:e?M(e):void 0}}var V=class{db;constructor(e=Ae){e instanceof ie.Database?this.db=e:(e!==":memory:"&&Ie(O),this.db=new ie.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addPendingMessagesToolUseIdAndWorkerPidColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.dropWorkerPidColumn()}dropWorkerPidColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32))return;if(this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="worker_pid"))try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),c.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(n){c.warn("DB","Failed to drop worker_pid column from pending_messages",{},n instanceof Error?n:new Error(String(n)))}this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}dropDeadPendingMessagesColumns(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31))return;let t=this.db.query("PRAGMA table_info(pending_messages)").all(),s=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch","worker_pid"].filter(i=>s.has(i));if(o.length>0){this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)try{this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),c.debug("DB",`Dropped dead column ${i} from pending_messages`)}catch(a){c.warn("DB",`Failed to drop column ${i} from pending_messages`,{},a instanceof Error?a:new Error(String(a)))}}this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}initializeSchema(){this.db.run(`
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Kt(n,o),m=d.platformSource??N,_=this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),m=new Date(d).toISOString(),_=q(e,s.title,s.narrative),E=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(_.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let m=a??Date.now(),_=new Date(m).toISOString();return this.db.transaction(()=>{let E=[],g=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),S=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let p of s){let A=q(e,p.title,p.narrative),h=g.get(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),o||null,i,p.agent_type??null,p.agent_id??null,A,_,m,d||null);if(h){E.push(h.id);continue}let l=S.get(e,A);if(!l)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${A}`);E.push(l.id)}let b=null;if(n){let A=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,_,m);b=Number(A.lastInsertRowid)}return{observationIds:E,summaryId:b,createdAtEpoch:m}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,m,_){let T=m??Date.now(),E=new Date(T).toISOString();return this.db.transaction(()=>{let S=[],b=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
      ...
      `).run(T,o),{observationIds:S,summaryId:A,createdAtEpoch:T}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),_=[...e],T=o?`WHERE id IN (${m}) AND project = ?`:`WHERE id IN (${m})`;o&&_.push(o);let g=this.db.prepare(`
      SELECT * FROM session_summaries
      ${T}
      ${a}
      ${d}
    `).all(..._);if(!i)return g;let S=new Map(g.map(b=>[b.id,b]));return e.map(b=>S.get(b)).filter(b=>!!b)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),_=[...e],T=o?"AND s.project = ?":"";o&&_.push(o);let g=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(..._);if(!i)return g;let S=new Map(g.map(b=>[b.id,b]));return e.map(b=>S.get(b)).filter(b=>!!b)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,m;if(e!==null){let p=`
  ...
  `).all(e,e,...s,...o,t.totalObservationCount)}function le(r,e,t){return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+ue)}function $e(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
...
`).filter(n=>n.trim());return{userMessage:"",assistantMessage:es(t)}}catch(e){return e instanceof Error?c.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):c.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{userMessage:"",assistantMessage:""}}}function pe(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=zt(s),a=ke.default.join(D,"projects",i,`${o}.jsonl`);return ts(a)}function Pe(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Ee(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function He(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function Ge(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function je(r){return[`# [${r}] recent context, ${Ge()}`,""]}function Xe(){return[`Legend: \u{1F3AF}session ${I.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function Be(){return[]}function We(){return[]}function qe(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function Ve(r){return[`### ${r}`]}function Ke(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function Ye(r,e,t){let s=r.title||"Untitled",n=I.getInstance().getTypeIcon(r.type),o=e?Ke(e):'"';return`${r.id} ${o} ${n} ${s}`}function Je(r,e,t,s){let n=[],o=r.title||"Untitled",i=I.getInstance().getTypeIcon(r.type),a=e?Ke(e):'"',{readTokens:d,discoveryDisplay:m}=P(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let _=[];return s.showReadTokens&&_.push(`~${d}t`),s.showWorkTokens&&_.push(m),_.length>0&&n.push(_.join(" ")),n.push(""),n}function Qe(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function H(r,e){return e?[`**${r}**: ${e}`,""]:[]}function ze(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function Ze(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function et(r){return`# [${r}] recent context, ${Ge()}

No previous sessions found.`}var tt={zh:{recentContext:"\u6700\u8FD1\u4E0A\u4E0B\u6587",legend:"\u56FE\u4F8B",legendSession:"\u4F1A\u8BDD\u8BF7\u6C42",columnKey:"\u5217\u8BF4\u660E",colReadDesc:"\u9605\u8BFB\u8FD9\u6761 observation \u7684\u8BCD\u5143\u6570(\u73B0\u5728\u5B66\u7684\u6210\u672C)",colWorkDesc:"\u4EA7\u51FA\u8FD9\u6761\u8BB0\u5F55\u82B1\u7684\u5DE5\u4F5C\u8BCD\u5143(\u8C03\u7814 / \u6784\u5EFA / \u51B3\u7B56)",contextIndex:"\u4E0A\u4E0B\u6587\u7D22\u5F15: \u8FD9\u4EFD\u8BED\u4E49\u7D22\u5F15(\u6807\u9898 / \u7C7B\u578B / \u6587\u4EF6 / \u8BCD\u5143)\u901A\u5E38\u8DB3\u4EE5\u7406\u89E3\u8FC7\u5F80\u5DE5\u4F5C\u3002",whenNeed:"\u5F53\u4F60\u9700\u8981\u5B9E\u73B0\u7EC6\u8282\u3001\u539F\u56E0\u6216\u8C03\u8BD5\u4E0A\u4E0B\u6587\u65F6:",fetchById:"\u6309 ID \u53D6: get_observations([IDs]) \u62C9\u53D6\u672C\u7D22\u5F15\u53EF\u89C1\u7684 observation",searchHistory:"\u641C\u5386\u53F2: \u7528 mem-search skill \u67E5\u8FC7\u5F80\u51B3\u7B56\u3001bug \u4E0E\u6DF1\u5EA6\u8C03\u7814",trustIndex:"\u4FE1\u4EFB\u672C\u7D22\u5F15,\u4E0D\u5FC5\u4E3A\u67E5\u8FC7\u5F80\u51B3\u7B56\u548C\u5B66\u5230\u7684\u5185\u5BB9\u91CD\u65B0\u8BFB\u4EE3\u7801",contextEconomics:"\u4E0A\u4E0B\u6587\u7ECF\u6D4E",loading:(r,e)=>`\u8F7D\u5165: ${r} \u6761 observation (${e} \u8BCD\u5143\u5F85\u8BFB)`,workInvest:r=>`\u5DE5\u4F5C\u6295\u5165: ${r} \u8BCD\u5143\u7528\u4E8E\u8C03\u7814\u3001\u6784\u5EFA\u4E0E\u51B3\u7B56`,yourSavings:"\u4F60\u8282\u7701",tokensSavings:(r,e)=>`${r} \u8BCD\u5143(\u590D\u7528\u51CF\u5C11 ${e}%)`,tokensOnly:r=>`${r} \u8BCD\u5143`,pctOnly:r=>`\u590D\u7528\u51CF\u5C11 ${r}%`,untitled:"\u672A\u547D\u540D",sessionStarted:"\u4F1A\u8BDD\u5F00\u59CB",previously:"\u4E4B\u524D",footerAccess:(r,e)=>`\u7528 ${e}t \u8BCD\u5143\u8BBF\u95EE\u8FC7\u5F80 ${r}k \u8BCD\u5143\u7684\u8C03\u7814\u4E0E\u51B3\u7B56\u3002\u7528 claude-mem-plus skill \u6309 ID \u53D6\u8BB0\u5FC6\u3002`,emptyState:"\u672C\u9879\u76EE\u6682\u65E0\u8FC7\u5F80\u4F1A\u8BDD\u3002"},en:{recentContext:"recent context",legend:"Legend",legendSession:"session-request",columnKey:"Column Key",colReadDesc:"Tokens to read this observation (cost to learn it now)",colWorkDesc:"Tokens spent on work that produced this record (research, building, deciding)",contextIndex:"Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.",whenNeed:"When you need implementation details, rationale, or debugging context:",fetchById:"Fetch by ID: get_observations([IDs]) for observations visible in this index",searchHistory:"Search history: Use the mem-search skill for past decisions, bugs, and deeper research",trustIndex:"Trust this index over re-reading code for past decisions and learnings",contextEconomics:"Context Economics",loading:(r,e)=>`Loading: ${r} observations (${e} tokens to read)`,workInvest:r=>`Work investment: ${r} tokens spent on research, building, and decisions`,yourSavings:"Your savings",tokensSavings:(r,e)=>`${r} tokens (${e}% reduction from reuse)`,tokensOnly:r=>`${r} tokens`,pctOnly:r=>`${r}% reduction from reuse`,untitled:"Untitled",sessionStarted:"Session started",previously:"Previously",footerAccess:(r,e)=>`Access ${r}k tokens of past research & decisions for just ${e}t. Use the claude-mem-plus skill to access memories by ID.`,emptyState:"No previous sessions found for this project yet."}},ss="zh";function R(){return tt[ss]||tt.en}function st(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function rt(r){return["",`${u.bright}${u.cyan}[${r}] ${R().recentContext}, ${st()}${u.reset}`,`${u.gray}${"\u2500".repeat(60)}${u.reset}`,""]}function nt(){let e=I.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${u.dim}${R().legend}: ${R().legendSession} | ${e}${u.reset}`,""]}function ot(){return[`${u.bright}${R().columnKey}${u.reset}`,`${u.dim}  Read: ${R().colReadDesc}${u.reset}`,`${u.dim}  Work: ${R().colWorkDesc}${u.reset}`,""]}function it(){return[`${u.dim}${R().contextIndex}${u.reset}`,"",`${u.dim}${R().whenNeed}${u.reset}`,`${u.dim}  - ${R().fetchById}${u.reset}`,`${u.dim}  - ${R().searchHistory}${u.reset}`,`${u.dim}  - ${R().trustIndex}${u.reset}`,""]}function at(r,e){let t=[],s=R();if(t.push(`${u.bright}${u.cyan}${s.contextEconomics}${u.reset}`),t.push(`${u.dim}  ${s.loading(r.totalObservations,r.totalReadTokens.toLocaleString())}${u.reset}`),t.push(`${u.dim}  ${s.workInvest(r.totalDiscoveryTokens.toLocaleString())}${u.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let n=`  ${s.yourSavings}: `;e.showSavingsAmount&&e.showSavingsPercent?n+=s.tokensSavings(r.savings.toLocaleString(),r.savingsPercent):e.showSavingsAmount?n+=s.tokensOnly(r.savings.toLocaleString()):n+=s.pctOnly(r.savingsPercent),t.push(`${u.green}${n}${u.reset}`)}return t.push(""),t}function dt(r){return[`${u.bright}${u.cyan}${r}${u.reset}`,""]}function ut(r){return[`${u.dim}${r}${u.reset}`]}function ct(r,e,t,s){let n=r.title||R().untitled,o=I.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=P(r,s),m=t?`${u.dim}${e}${u.reset}`:" ".repeat(e.length),_=s.showReadTokens&&i>0?`${u.dim}(~${i}t)${u.reset}`:"",T=s.showWorkTokens&&a>0?`${u.dim}(${d} ${a.toLocaleString()}t)${u.reset}`:"";return`  ${u.dim}#${r.id}${u.reset}  ${m}  ${o}  ${n} ${_} ${T}`}function _t(r,e,t,s,n){let o=[],i=r.title||R().untitled,a=I.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:m,workEmoji:_}=P(r,n),T=t?`${u.dim}${e}${u.reset}`:" ".repeat(e.length),E=n.showReadTokens&&d>0?`${u.dim}(~${d}t)${u.reset}`:"",g=n.showWorkTokens&&m>0?`${u.dim}(${_} ${m.toLocaleString()}t)${u.reset}`:"";return o.push(`  ${u.dim}#${r.id}${u.reset}  ${T}  ${a}  ${u.bright}${i}${u.reset}`),s&&o.push(`    ${u.dim}${s}${u.reset}`),(E||g)&&o.push(`    ${E} ${g}`),o.push(""),o}function mt(r,e){let t=`${r.request||R().sessionStarted} (${e})`;return[`${u.yellow}#S${r.id}${u.reset} ${t}`,""]}function G(r,e,t){return e?[`${t}${r}:${u.reset} ${e}`,""]:[]}function lt(r){return r.assistantMessage?["","---","",`${u.bright}${u.magenta}${R().previously}${u.reset}`,"",`${u.dim}A: ${r.assistantMessage}${u.reset}`,""]:[]}function pt(r,e){let t=Math.round(r/1e3);return["",`${u.dim}${R().footerAccess(t,e.toLocaleString())}${u.reset}`]}function Et(r){return`
${u.bright}${u.cyan}[${r}] ${R().recentContext}, ${st()}${u.reset}
${u.gray}${"\u2500".repeat(60)}${u.reset}

${u.dim}${R().emptyState}${u.reset}
`}function gt(r,e,t,s){let n=[];return s?n.push(...rt(r)):n.push(...je(r)),s?n.push(...nt()):n.push(...Xe()),s?n.push(...ot()):n.push(...Be()),s?n.push(...it()):n.push(...We()),J(t)&&(s?n.push(...at(e,t)):n.push(...qe(e,t))),n}var ge=x(require("path"),1);function ee(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return c.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Te(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function fe(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function ft(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Tt(r,e){return ge.default.isAbsolute(r)?ge.default.relative(e,r):r}function St(r,e,t){let s=ee(r);if(s.length>0)return Tt(s[0],e);if(t){let n=ee(t);if(n.length>0)return Tt(n[0],e)}return"General"}function rs(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=ft(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function bt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?ee(r.facts).join(`
`):null}function ns(r,e,t,s){let n=[];n.push(...Ve(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Te(a.displayTime);n.push(...Qe(a,d))}else{let a=i.data,d=fe(a.created_at),_=d!==o?d:"";if(o=d,t.has(a.id)){let E=bt(a,s);n.push(...Je(a,_,E,s))}else n.push(Ye(a,_,s))}return n}function os(r,e,t,s,n){let o=[];o.push(...dt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let m=d.data,_=Te(m.displayTime);o.push(...mt(m,_))}else{let m=d.data,_=St(m.files_modified,n,m.files_read),T=fe(m.created_at),E=T!==a;a=T;let g=t.has(m.id);if(_!==i&&(o.push(...ut(_)),i=_),g){let S=bt(m,s);o.push(..._t(m,T,E,S,s))}else o.push(ct(m,T,E,s))}return o.push(""),o}function is(r,e,t,s,n,o){return o?os(r,e,t,s,n):ns(r,e,t,s)}function ht(r,e,t,s,n){let o=[],i=rs(r);for(let[a,d]of i)o.push(...is(a,d,e,t,s,n));return o}function Ot(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Rt(r,e){let t=[];return e?(t.push(...G("Investigated",r.investigated,u.blue)),t.push(...G("Learned",r.learned,u.yellow)),t.push(...G("Completed",r.completed,u.green)),t.push(...G("Next Steps",r.next_steps,u.magenta))):(t.push(...H("Investigated",r.investigated)),t.push(...H("Learned",r.learned)),t.push(...H("Completed",r.completed)),t.push(...H("Next Steps",r.next_steps))),t}function At(r,e){return e?lt(r):ze(r)}function Nt(r,e,t){return!J(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?pt(r.totalDiscoveryTokens,r.totalReadTokens):Ze(r.totalDiscoveryTokens,r.totalReadTokens)}var as=It.default.join((0,Ct.homedir)(),".claude","plugins","marketplaces","bjarne56","plugin",".install-version");function ds(){try{return new V}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Lt.unlinkSync)(as)}catch(e){e instanceof Error?c.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):c.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return c.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function us(r,e){return e?Et(r):et(r)}function cs(r,e,t,s,n,o,i){let a=[],d=_e(e);a.push(...gt(r,d,s,i));let m=t.slice(0,s.sessionCount),_=Pe(m,t),T=Ee(e,_),E=He(e,s.fullObservationCount);a.push(...ht(T,E,s,n,i));let g=t[0],S=e[0];Ot(s,g,S)&&a.push(...Rt(g,i));let b=pe(e,s,o,n);return a.push(...At(b,i)),a.push(...Nt(d,s,i)),a.join(`
`).trimEnd()}async function Se(r,e=!1){let t=de(),s=r?.cwd??process.cwd(),n=ne(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=ds();if(!a)return"";try{let d=o.length>1?$e(a,o,t):me(a,i,t),m=o.length>1?Fe(a,o,t):le(a,i,t);return d.length===0&&m.length===0?us(i,e):cs(i,d,m,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
