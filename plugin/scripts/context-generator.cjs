"use strict";var Dt=Object.create;var X=Object.defineProperty;var Mt=Object.getOwnPropertyDescriptor;var Ut=Object.getOwnPropertyNames;var xt=Object.getPrototypeOf,wt=Object.prototype.hasOwnProperty;var Pt=(r,e)=>{for(var t in e)X(r,t,{get:e[t],enumerable:!0})},Ne=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ut(e))!wt.call(r,n)&&n!==t&&X(r,n,{get:()=>e[n],enumerable:!(s=Mt(e,n))||s.enumerable});return r};var x=(r,e,t)=>(t=r!=null?Dt(xt(r)):{},Ne(e||!r||!r.__esModule?X(t,"default",{value:r,enumerable:!0}):t,r)),jt=r=>Ne(X({},"__esModule",{value:!0}),r);var ms={};Pt(ms,{generateContext:()=>be});module.exports=jt(ms);var Lt=x(require("path"),1),vt=require("os"),yt=require("fs");var ce=require("bun:sqlite");var T=require("path"),B=require("os"),D=require("fs");var Ie=require("url");var v=require("fs"),Ae=require("path");var re=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(re||{}),ne=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=w.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ae.join)(e,`claude-mem-plus-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=w.settings();if((0,v.existsSync)(e)){let t=(0,v.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=re[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",m={...s,location:_};return this.warn(e,`[HAPPY-PATH] ${t}`,m,n),o}},u=new ne;var Vt={};function $t(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,Ie.fileURLToPath)(Vt.url))}var Ft=$t();function kt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,T.join)((0,B.homedir)(),".claude-mem-plus"),e=(0,T.join)((0,B.homedir)(),".claude-mem");for(let t of[r,e]){let s=(0,T.join)(t,"settings.json");try{if((0,D.existsSync)(s)){let n=JSON.parse((0,D.readFileSync)(s,"utf-8")),o=n.env??n;return o.CLAUDE_MEM_DATA_DIR?o.CLAUDE_MEM_DATA_DIR:t}}catch{}}return r}var R=kt(),M=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,B.homedir)(),".claude"),Ss=(0,T.join)(M,"plugins","marketplaces","bjarne56"),Ht=(0,T.join)(R,"archives"),Gt=(0,T.join)(R,"logs"),Xt=(0,T.join)(R,"trash"),Bt=(0,T.join)(R,"backups"),Wt=(0,T.join)(R,"modes"),bs=(0,T.join)(R,"settings.json"),oe=(0,T.join)(R,"claude-mem.db"),Yt=(0,T.join)(R,"vector-db"),Ce=(0,T.join)(R,"observer-sessions"),W=(0,T.basename)(Ce),Rs=(0,T.join)(M,"settings.json"),Os=(0,T.join)(M,"commands"),Ns=(0,T.join)(M,"CLAUDE.md");function ie(r){(0,D.mkdirSync)(r,{recursive:!0})}function Le(){return(0,T.join)(Ft,"..")}var w={dataDir:()=>R,workerPid:()=>(0,T.join)(R,"worker.pid"),settings:()=>(0,T.join)(R,"settings.json"),database:()=>(0,T.join)(R,"claude-mem.db"),chroma:()=>(0,T.join)(R,"chroma"),combinedCerts:()=>(0,T.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(R,"transcript-watch-state.json"),corpora:()=>(0,T.join)(R,"corpora"),supervisorRegistry:()=>(0,T.join)(R,"supervisor.json"),envFile:()=>(0,T.join)(R,".env"),logsDir:()=>Gt,archives:()=>Ht,trash:()=>Xt,backups:()=>Bt,modes:()=>Wt,vectorDb:()=>Yt,observerSessions:()=>Ce};var xe=require("crypto");var ye=require("os"),De=x(require("path"),1);var V=require("fs"),Y=x(require("path"),1),P={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function ve(r){let e=Y.default.join(r,".git"),t;try{t=(0,V.statSync)(e)}catch(_){return _ instanceof Error&&_.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",_),P}if(!t.isFile())return P;let s;try{s=(0,V.readFileSync)(e,"utf-8").trim()}catch(_){return console.warn("[worktree] Failed to read .git file:",_ instanceof Error?_.message:String(_)),P}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return P;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return P;let a=i[1],d=Y.default.basename(r),p=Y.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:p}}function Me(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,ye.homedir)()):r}function Ue(r){if(!r||r.trim()==="")return u.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=Me(r),t=De.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return u.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return u.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function ae(r){let e=Ue(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=Me(r),s=ve(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}var qt=require("bun:sqlite");function q(r,e,t){return(0,xe.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function de(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var I="claude";function Kt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function U(r){if(!r)return I;let e=Kt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:I}function we(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Jt(r,e){return{customTitle:r,platformSource:e?U(e):void 0}}var K=class{db;constructor(e=oe){e instanceof ce.Database?this.db=e:(e!==":memory:"&&ie(R),this.db=new ce.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureProjectsTables(),this.migrateProjectIdToInt()}migrateProjectIdToInt(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(34))return;if(this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='projects'").all().length===0){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(34,new Date().toISOString());return}let n=this.db.query("PRAGMA table_info(projects)").all().find(p=>p.name==="id");if(n&&n.type?.toUpperCase().startsWith("INTEGER")){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(34,new Date().toISOString());return}u.info("DB","[migration v34] \u9879\u76EE ID \u4ECE TEXT(p_xxx)\u8FC1\u5230 INTEGER(8 \u4F4D\u6570\u5B57)\u5F00\u59CB");let o=1e7,i=99999999,a=new Set,d=()=>{for(let p=0;p<1e3;p++){let _=Math.floor(o+Math.random()*(i-o+1));if(!a.has(_))return a.add(_),_}throw new Error("Failed to allocate 8-digit project ID after 1000 retries")};this.db.transaction(()=>{this.db.run(`CREATE TEMP TABLE _project_id_map (
    ...
    `).all(e)}getAllProjects(e){let t=e?U(e):void 0,s=`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[W];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(I,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
  ...
  `).all(...e,...e,...s,...o,t.totalObservationCount)}function ke(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t.sessionCount+_e)}function es(r){return r.replace(/\//g,"-")}function ts(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(je,"").trim(),t)return t}return null}function ss(r){for(let e=r.length-1;e>=0;e--)try{let t=ts(r[e]);if(t)return t}catch(t){t instanceof Error?u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function rs(r){try{if(!(0,Z.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,Z.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{userMessage:"",assistantMessage:ss(t)}}catch(e){return e instanceof Error?u.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):u.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{userMessage:"",assistantMessage:""}}}function Te(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=es(s),a=$e.default.join(M,"projects",i,`${o}.jsonl`);return rs(a)}function He(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function he(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function Ge(r,e){return new Set(r.slice(0,e).map(t=>t.id))}var fe=x(require("path"),1);function ee(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function k(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Se(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Be(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Xe(r,e){return fe.default.isAbsolute(r)?fe.default.relative(e,r):r}function We(r,e,t){let s=ee(r);if(s.length>0)return Xe(s[0],e);if(t){let n=ee(t);if(n.length>0)return Xe(n[0],e)}return"General"}function Ye(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Ve(r){return[`# [${r}] recent context, ${Ye()}`,""]}function qe(){return[`Legend: \u{1F3AF}session ${C.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function Ke(){return[]}function Je(){return[]}function Qe(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function ze(r){return[`### ${r}`]}function Ze(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function et(r,e,t){let s=r.title||"Untitled",n=C.getInstance().getTypeIcon(r.type),o=e?Ze(e):'"';return`${r.id} ${o} ${n} ${s}`}function tt(r,e,t,s){let n=[],o=r.title||"Untitled",i=C.getInstance().getTypeIcon(r.type),a=e?Ze(e):'"',{readTokens:d,discoveryDisplay:p}=F(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let _=[];return s.showReadTokens&&_.push(`~${d}t`),s.showWorkTokens&&_.push(p),_.length>0&&n.push(_.join(" ")),n.push(""),n}function st(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function H(r,e){return e?[`**${r}**: ${e}`,""]:[]}function rt(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function nt(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function ot(r){return`# [${r}] recent context, ${Ye()}

No previous sessions found.`}var it={zh:{recentContext:"\u6700\u8FD1\u4E0A\u4E0B\u6587",legend:"\u56FE\u4F8B",legendSession:"\u4F1A\u8BDD\u8BF7\u6C42",columnKey:"\u5217\u8BF4\u660E",colReadDesc:"\u9605\u8BFB\u8FD9\u6761 observation \u7684\u8BCD\u5143\u6570(\u73B0\u5728\u5B66\u7684\u6210\u672C)",colWorkDesc:"\u4EA7\u51FA\u8FD9\u6761\u8BB0\u5F55\u82B1\u7684\u5DE5\u4F5C\u8BCD\u5143(\u8C03\u7814 / \u6784\u5EFA / \u51B3\u7B56)",contextIndex:"\u4E0A\u4E0B\u6587\u7D22\u5F15: \u8FD9\u4EFD\u8BED\u4E49\u7D22\u5F15(\u6807\u9898 / \u7C7B\u578B / \u6587\u4EF6 / \u8BCD\u5143)\u901A\u5E38\u8DB3\u4EE5\u7406\u89E3\u8FC7\u5F80\u5DE5\u4F5C\u3002",whenNeed:"\u5F53\u4F60\u9700\u8981\u5B9E\u73B0\u7EC6\u8282\u3001\u539F\u56E0\u6216\u8C03\u8BD5\u4E0A\u4E0B\u6587\u65F6:",fetchById:"\u6309 ID \u53D6: get_observations([IDs]) \u62C9\u53D6\u672C\u7D22\u5F15\u53EF\u89C1\u7684 observation",searchHistory:"\u641C\u5386\u53F2: \u7528 mem-search skill \u67E5\u8FC7\u5F80\u51B3\u7B56\u3001bug \u4E0E\u6DF1\u5EA6\u8C03\u7814",trustIndex:"\u4FE1\u4EFB\u672C\u7D22\u5F15,\u4E0D\u5FC5\u4E3A\u67E5\u8FC7\u5F80\u51B3\u7B56\u548C\u5B66\u5230\u7684\u5185\u5BB9\u91CD\u65B0\u8BFB\u4EE3\u7801",contextEconomics:"\u4E0A\u4E0B\u6587\u7ECF\u6D4E",loading:(r,e)=>`\u8F7D\u5165: ${r} \u6761 observation (${e} \u8BCD\u5143\u5F85\u8BFB)`,workInvest:r=>`\u5DE5\u4F5C\u6295\u5165: ${r} \u8BCD\u5143\u7528\u4E8E\u8C03\u7814\u3001\u6784\u5EFA\u4E0E\u51B3\u7B56`,yourSavings:"\u4F60\u8282\u7701",tokensSavings:(r,e)=>`${r} \u8BCD\u5143(\u590D\u7528\u51CF\u5C11 ${e}%)`,tokensOnly:r=>`${r} \u8BCD\u5143`,pctOnly:r=>`\u590D\u7528\u51CF\u5C11 ${r}%`,untitled:"\u672A\u547D\u540D",sessionStarted:"\u4F1A\u8BDD\u5F00\u59CB",previously:"\u4E4B\u524D",footerAccess:(r,e)=>`\u7528 ${e}t \u8BCD\u5143\u8BBF\u95EE\u8FC7\u5F80 ${r}k \u8BCD\u5143\u7684\u8C03\u7814\u4E0E\u51B3\u7B56\u3002\u7528 claude-mem-plus skill \u6309 ID \u53D6\u8BB0\u5FC6\u3002`,emptyState:"\u672C\u9879\u76EE\u6682\u65E0\u8FC7\u5F80\u4F1A\u8BDD\u3002"},en:{recentContext:"recent context",legend:"Legend",legendSession:"session-request",columnKey:"Column Key",colReadDesc:"Tokens to read this observation (cost to learn it now)",colWorkDesc:"Tokens spent on work that produced this record (research, building, deciding)",contextIndex:"Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.",whenNeed:"When you need implementation details, rationale, or debugging context:",fetchById:"Fetch by ID: get_observations([IDs]) for observations visible in this index",searchHistory:"Search history: Use the mem-search skill for past decisions, bugs, and deeper research",trustIndex:"Trust this index over re-reading code for past decisions and learnings",contextEconomics:"Context Economics",loading:(r,e)=>`Loading: ${r} observations (${e} tokens to read)`,workInvest:r=>`Work investment: ${r} tokens spent on research, building, and decisions`,yourSavings:"Your savings",tokensSavings:(r,e)=>`${r} tokens (${e}% reduction from reuse)`,tokensOnly:r=>`${r} tokens`,pctOnly:r=>`${r}% reduction from reuse`,untitled:"Untitled",sessionStarted:"Session started",previously:"Previously",footerAccess:(r,e)=>`Access ${r}k tokens of past research & decisions for just ${e}t. Use the claude-mem-plus skill to access memories by ID.`,emptyState:"No previous sessions found for this project yet."}},ns="zh";function O(){return it[ns]||it.en}function at(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function dt(r){return["",`${c.bright}${c.cyan}[${r}] ${O().recentContext}, ${at()}${c.reset}`,`${c.gray}${"\u2500".repeat(60)}${c.reset}`,""]}function ct(){let e=C.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${c.dim}${O().legend}: ${O().legendSession} | ${e}${c.reset}`,""]}function ut(){return[`${c.bright}${O().columnKey}${c.reset}`,`${c.dim}  Read: ${O().colReadDesc}${c.reset}`,`${c.dim}  Work: ${O().colWorkDesc}${c.reset}`,""]}function pt(){return[`${c.dim}${O().contextIndex}${c.reset}`,"",`${c.dim}${O().whenNeed}${c.reset}`,`${c.dim}  - ${O().fetchById}${c.reset}`,`${c.dim}  - ${O().searchHistory}${c.reset}`,`${c.dim}  - ${O().trustIndex}${c.reset}`,""]}function _t(r,e){let t=[],s=O();if(t.push(`${c.bright}${c.cyan}${s.contextEconomics}${c.reset}`),t.push(`${c.dim}  ${s.loading(r.totalObservations,r.totalReadTokens.toLocaleString())}${c.reset}`),t.push(`${c.dim}  ${s.workInvest(r.totalDiscoveryTokens.toLocaleString())}${c.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let n=`  ${s.yourSavings}: `;e.showSavingsAmount&&e.showSavingsPercent?n+=s.tokensSavings(r.savings.toLocaleString(),r.savingsPercent):e.showSavingsAmount?n+=s.tokensOnly(r.savings.toLocaleString()):n+=s.pctOnly(r.savingsPercent),t.push(`${c.green}${n}${c.reset}`)}return t.push(""),t}function lt(r){return[`${c.bright}${c.cyan}${r}${c.reset}`,""]}function mt(r){return[`${c.dim}${r}${c.reset}`]}function Et(r,e,t,s){let n=r.title||O().untitled,o=C.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=F(r,s),p=t?`${c.dim}${e}${c.reset}`:" ".repeat(e.length),_=s.showReadTokens&&i>0?`${c.dim}(~${i}t)${c.reset}`:"",m=s.showWorkTokens&&a>0?`${c.dim}(${d} ${a.toLocaleString()}t)${c.reset}`:"";return`  ${c.dim}#${r.id}${c.reset}  ${p}  ${o}  ${n} ${_} ${m}`}function gt(r,e,t,s,n){let o=[],i=r.title||O().untitled,a=C.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:p,workEmoji:_}=F(r,n),m=t?`${c.dim}${e}${c.reset}`:" ".repeat(e.length),E=n.showReadTokens&&d>0?`${c.dim}(~${d}t)${c.reset}`:"",g=n.showWorkTokens&&p>0?`${c.dim}(${_} ${p.toLocaleString()}t)${c.reset}`:"";return o.push(`  ${c.dim}#${r.id}${c.reset}  ${m}  ${a}  ${c.bright}${i}${c.reset}`),s&&o.push(`    ${c.dim}${s}${c.reset}`),(E||g)&&o.push(`    ${E} ${g}`),o.push(""),o}function Tt(r,e){let t=`${r.request||O().sessionStarted} (${e})`;return[`${c.yellow}#S${r.id}${c.reset} ${t}`,""]}function G(r,e,t){return e?[`${t}${r}:${c.reset} ${e}`,""]:[]}function ht(r){return r.assistantMessage?["","---","",`${c.bright}${c.magenta}${O().previously}${c.reset}`,"",`${c.dim}A: ${r.assistantMessage}${c.reset}`,""]:[]}function ft(r,e){let t=Math.round(r/1e3);return["",`${c.dim}${O().footerAccess(t,e.toLocaleString())}${c.reset}`]}function St(r){return`
${c.bright}${c.cyan}[${r}] ${O().recentContext}, ${at()}${c.reset}
${c.gray}${"\u2500".repeat(60)}${c.reset}

${c.dim}${O().emptyState}${c.reset}
`}function os(r,e,t){if(!r&&!e)return[];let s=r?.created_at_epoch??0,n=e?.created_at_epoch??0,o=s>=n,i=o?`#${r.id}`:`#S${e.id}`,a=o?r.created_at:e.created_at,d=k(a);return t?[`${c.dim}\u{1F4CC} latest: ${i} (${d})${c.reset}`,""]:[`Latest: ${i} (${d})`,""]}function bt(r,e,t,s,n,o){let i=[];return s?i.push(...dt(r)):i.push(...Ve(r)),i.push(...os(n,o,s)),s?i.push(...ct()):i.push(...qe()),s?i.push(...ut()):i.push(...Ke()),s?i.push(...pt()):i.push(...Je()),z(t)&&(s?i.push(..._t(e,t)):i.push(...Qe(e,t))),i}function is(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Be(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}for(let[,s]of e)s.sort((n,o)=>{let i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return(o.type==="observation"?o.data.created_at_epoch:o.data.displayEpoch)-i});let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime();return new Date(n[0]).getTime()-o});return new Map(t)}function Rt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?ee(r.facts).join(`
`):null}function as(r,e,t,s){let n=[];n.push(...ze(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=k(a.displayTime);n.push(...st(a,d))}else{let a=i.data,d=Se(a.created_at),_=d!==o?d:"";if(o=d,t.has(a.id)){let E=Rt(a,s);n.push(...tt(a,_,E,s))}else n.push(et(a,_,s))}return n}function ds(r,e,t,s,n){let o=[];o.push(...lt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let p=d.data,_=k(p.displayTime);o.push(...Tt(p,_))}else{let p=d.data,_=We(p.files_modified,n,p.files_read),m=Se(p.created_at),E=m!==a;a=m;let g=t.has(p.id);if(_!==i&&(o.push(...mt(_)),i=_),g){let h=Rt(p,s);o.push(...gt(p,m,E,h,s))}else o.push(Et(p,m,E,s))}return o.push(""),o}function cs(r,e,t,s,n,o){return o?ds(r,e,t,s,n):as(r,e,t,s)}function Ot(r,e,t,s,n){let o=[],i=is(r);for(let[a,d]of i)o.push(...cs(a,d,e,t,s,n));return o}function Nt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function At(r,e){let t=[];return e?(t.push(...G("Investigated",r.investigated,c.blue)),t.push(...G("Learned",r.learned,c.yellow)),t.push(...G("Completed",r.completed,c.green)),t.push(...G("Next Steps",r.next_steps,c.magenta))):(t.push(...H("Investigated",r.investigated)),t.push(...H("Learned",r.learned)),t.push(...H("Completed",r.completed)),t.push(...H("Next Steps",r.next_steps))),t}function It(r,e){return e?ht(r):rt(r)}function Ct(r,e,t){return!z(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?ft(r.totalDiscoveryTokens,r.totalReadTokens):nt(r.totalDiscoveryTokens,r.totalReadTokens)}var us=Lt.default.join((0,vt.homedir)(),".claude","plugins","marketplaces","bjarne56","plugin",".install-version");function ps(){try{return new K}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,yt.unlinkSync)(us)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function _s(r,e){return e?St(r):ot(r)}function ls(r,e,t,s,n,o,i){let a=[],d=me(e);a.push(...bt(r,d,s,i,e[0],t[0]));let p=t.slice(0,s.sessionCount),_=He(p,t),m=he(e,_),E=Ge(e,s.fullObservationCount);a.push(...Ot(m,E,s,n,i));let g=t[0],h=e[0];Nt(s,g,h)&&a.push(...At(g,i));let f=Te(e,s,o,n);return a.push(...It(f,i)),a.push(...Ct(d,s,i)),a.join(`
`).trimEnd()}async function be(r,e=!1){let t=pe(),s=r?.cwd??process.cwd(),n=ae(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=ps();if(!a)return"";try{let d=o.length>1?Fe(a,o,t):Ee(a,i,t),p=o.length>1?ke(a,o,t):ge(a,i,t);return d.length===0&&p.length===0?_s(i,e):ls(i,d,p,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
