...
📚 **[Tingnan ang Buong Dokumentasyon](https://docs.claude-mem-plus.ai/)** - I-browse sa opisyal na website

### Pagsisimula

- **[Gabay sa Pag-install](https://docs.claude-mem-plus.ai/installation)** - Mabilis na pagsisimula at advanced installation
- **[Gabay sa Paggamit](https://docs.claude-mem-plus.ai/usage/getting-started)** - Paano awtomatikong gumagana ang Claude-Mem
- **[Mga Search Tool](https://docs.claude-mem-plus.ai/usage/search-tools)** - I-query ang history ng proyekto gamit ang natural language
- **[Mga Beta Feature](https://docs.claude-mem-plus.ai/beta-features)** - Subukan ang mga experimental feature tulad ng Endless Mode

### Best Practices

- **[Context Engineering](https://docs.claude-mem-plus.ai/context-engineering)** - Mga prinsipyo ng context optimization para sa AI agents
- **[Progressive Disclosure](https://docs.claude-mem-plus.ai/progressive-disclosure)** - Pilosopiya sa likod ng context priming strategy ng Claude-Mem

### Arkitektura

- **[Overview](https://docs.claude-mem-plus.ai/architecture/overview)** - Mga bahagi ng sistema at daloy ng data
- **[Architecture Evolution](https://docs.claude-mem-plus.ai/architecture-evolution)** - Ang paglalakbay mula v3 hanggang v5
- **[Hooks Architecture](https://docs.claude-mem-plus.ai/hooks-architecture)** - Paano gumagamit ang Claude-Mem ng lifecycle hooks
- **[Hooks Reference](https://docs.claude-mem-plus.ai/architecture/hooks)** - 7 hook scripts, ipinaliwanag
- **[Worker Service](https://docs.claude-mem-plus.ai/architecture/worker-service)** - HTTP API at Bun management
- **[Database](https://docs.claude-mem-plus.ai/architecture/database)** - SQLite schema at FTS5 search
- **[Search Architecture](https://docs.claude-mem-plus.ai/architecture/search-architecture)** - Hybrid search gamit ang Chroma vector database

### Konpigurasyon at Pagbuo

- **[Konpigurasyon](https://docs.claude-mem-plus.ai/configuration)** - Environment variables at settings
- **[Pagbuo](https://docs.claude-mem-plus.ai/development)** - Build, test, at contribution workflow
- **[Pag-troubleshoot](https://docs.claude-mem-plus.ai/troubleshooting)** - Karaniwang isyu at solusyon
...
Tingnan ang [Architecture Overview](https://docs.claude-mem-plus.ai/architecture/overview) para sa detalye.
...
Tingnan ang [Search Tools Guide](https://docs.claude-mem-plus.ai/usage/search-tools) para sa mas detalyadong mga halimbawa.
...
Tingnan ang **[Dokumentasyon ng Mga Beta Feature](https://docs.claude-mem-plus.ai/beta-features)** para sa detalye ng Endless Mode at kung paano ito subukan.
...
Pinamamahalaan ang settings sa `~/.claude-mem-plus/settings.json` (auto-created na may defaults sa unang run). I-configure ang AI model, worker port, data directory, log level, at context injection settings.

Tingnan ang **[Gabay sa Konpigurasyon](https://docs.claude-mem-plus.ai/configuration)** para sa lahat ng available na settings at mga halimbawa.

---

## Pagbuo

Tingnan ang **[Gabay nang pagbuo](https://docs.claude-mem-plus.ai/development)** para sa pag build instructions, testing, at contribution workflow.
...
Tingnan ang **[Troubleshooting Guide](https://docs.claude-mem-plus.ai/troubleshooting)** para sa mga karaniwang isyu at solusyon.
...
Tingnan ang [Gabay nang pagbuo](https://docs.claude-mem-plus.ai/development) para sa contribution workflow.
