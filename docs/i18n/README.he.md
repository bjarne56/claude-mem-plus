...
📚 **[צפה בתיעוד המלא](https://docs.claude-mem-plus.ai/)** - דפדף באתר הרשמי

### תחילת העבודה

- **[מדריך התקנה](https://docs.claude-mem-plus.ai/installation)** - התחלה מהירה והתקנה מתקדמת
- **[מדריך שימוש](https://docs.claude-mem-plus.ai/usage/getting-started)** - איך Claude-Mem עובד אוטומטית
- **[כלי חיפוש](https://docs.claude-mem-plus.ai/usage/search-tools)** - שאל את היסטוריית הפרויקט שלך בשפה טבעית
- **[תכונות בטא](https://docs.claude-mem-plus.ai/beta-features)** - נסה תכונות ניסיוניות כמו Endless Mode

### שיטות מומלצות

- **[הנדסת הקשר](https://docs.claude-mem-plus.ai/context-engineering)** - עקרונות אופטימיזציה של הקשר לסוכן AI
- **[גילוי מדורג](https://docs.claude-mem-plus.ai/progressive-disclosure)** - הפילוסופיה מאחורי אסטרטגיית הכנת ההקשר של Claude-Mem

### ארכיטקטורה

- **[סקירה כללית](https://docs.claude-mem-plus.ai/architecture/overview)** - רכיבי המערכת וזרימת הנתונים
- **[התפתחות הארכיטקטורה](https://docs.claude-mem-plus.ai/architecture-evolution)** - המסע מגרסה 3 לגרסה 5
- **[ארכיטקטורת Hooks](https://docs.claude-mem-plus.ai/hooks-architecture)** - איך Claude-Mem משתמש ב-lifecycle hooks
- **[מדריך Hooks](https://docs.claude-mem-plus.ai/architecture/hooks)** - 7 סקריפטי hook מוסברים
- **[שירות Worker](https://docs.claude-mem-plus.ai/architecture/worker-service)** - HTTP API וניהול Bun
- **[מסד נתונים](https://docs.claude-mem-plus.ai/architecture/database)** - סכמת SQLite וחיפוש FTS5
- **[ארכיטקטורת חיפוש](https://docs.claude-mem-plus.ai/architecture/search-architecture)** - חיפוש היברידי עם מסד נתוני וקטורים Chroma

### הגדרות ופיתוח

- **[הגדרות](https://docs.claude-mem-plus.ai/configuration)** - משתני סביבה והגדרות
- **[פיתוח](https://docs.claude-mem-plus.ai/development)** - בנייה, בדיקה, תרומה
- **[פתרון בעיות](https://docs.claude-mem-plus.ai/troubleshooting)** - בעיות נפוצות ופתרונות
...
ראה [סקירה כללית של הארכיטקטורה](https://docs.claude-mem-plus.ai/architecture/overview) לפרטים.
...
ראה [מדריך כלי חיפוש](https://docs.claude-mem-plus.ai/usage/search-tools) לדוגמאות מפורטות.
...
ראה **[תיעוד תכונות בטא](https://docs.claude-mem-plus.ai/beta-features)** לפרטים על Endless Mode ואיך לנסות אותו.
...
ההגדרות מנוהלות ב-`~/.claude-mem-plus/settings.json` (נוצר אוטומטית עם ברירות מחדל בהפעלה הראשונה). הגדר מודל AI, פורט worker, ספריית נתונים, רמת לוג, והגדרות הזרקת הקשר.

ראה **[מדריך הגדרות](https://docs.claude-mem-plus.ai/configuration)** לכל ההגדרות הזמינות ודוגמאות.

---

## פיתוח

ראה **[מדריך פיתוח](https://docs.claude-mem-plus.ai/development)** להוראות בנייה, בדיקה, ותהליך תרומה.
...
ראה **[מדריך פתרון בעיות](https://docs.claude-mem-plus.ai/troubleshooting)** לבעיות נפוצות ופתרונות.
...
ראה [מדריך פיתוח](https://docs.claude-mem-plus.ai/development) לתהליך תרומה.
...
זכויות יוצרים (C) 2025 Alex Newman (@bjarne56). כל הזכויות שמורות.
...
- **תיעוד**: [docs/](docs/)
- **בעיות**: [GitHub Issues](https://github.com/bjarne56/claude-mem-plus-plus/issues)
- **מאגר**: [github.com/bjarne56/claude-mem-plus-plus](https://github.com/bjarne56/claude-mem-plus-plus)
- **מחבר**: Alex Newman ([@bjarne56](https://github.com/bjarne56))
