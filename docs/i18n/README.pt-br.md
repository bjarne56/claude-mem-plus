...
- **[Ferramentas de Busca](https://docs.claude-mem-plus.ai/usage/search-tools)** - Consulte seu histórico de projeto com linguagem natural
...
- **[Banco de Dados](https://docs.claude-mem-plus.ai/architecture/database)** - Schema SQLite e busca FTS5
- **[Arquitetura de Busca](https://docs.claude-mem-plus.ai/architecture/search-architecture)** - Busca híbrida com banco de dados vetorial Chroma
...
Veja [Guia de Ferramentas de Busca](https://docs.claude-mem-plus.ai/usage/search-tools) para exemplos detalhados.
