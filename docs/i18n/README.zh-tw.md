...
- **[安裝指南](https://docs.claude-mem-plus.ai/installation)** - 快速開始與進階安裝
- **[使用指南](https://docs.claude-mem-plus.ai/usage/getting-started)** - Claude-Mem 如何自動運作
- **[搜尋工具](https://docs.claude-mem-plus.ai/usage/search-tools)** - 使用自然語言查詢專案歷史
- **[Beta 功能](https://docs.claude-mem-plus.ai/beta-features)** - 試用 Endless Mode 等實驗性功能

### 最佳實務

- **[脈絡工程](https://docs.claude-mem-plus.ai/context-engineering)** - AI 代理脈絡最佳化原則
- **[漸進式揭露](https://docs.claude-mem-plus.ai/progressive-disclosure)** - Claude-Mem 脈絡啟動策略背後的理念

### 架構

- **[概覽](https://docs.claude-mem-plus.ai/architecture/overview)** - 系統元件與資料流程
- **[架構演進](https://docs.claude-mem-plus.ai/architecture-evolution)** - 從 v3 到 v5 的旅程
- **[Hooks 架構](https://docs.claude-mem-plus.ai/hooks-architecture)** - Claude-Mem 如何使用生命週期掛鉤
- **[Hooks 參考](https://docs.claude-mem-plus.ai/architecture/hooks)** - 7 個掛鉤腳本說明
- **[Worker 服務](https://docs.claude-mem-plus.ai/architecture/worker-service)** - HTTP API 與 Bun 管理
- **[資料庫](https://docs.claude-mem-plus.ai/architecture/database)** - SQLite 結構描述與 FTS5 搜尋
- **[搜尋架構](https://docs.claude-mem-plus.ai/architecture/search-architecture)** - 使用 Chroma 向量資料庫的混合搜尋

### 設定與開發

- **[設定](https://docs.claude-mem-plus.ai/configuration)** - 環境變數與設定
- **[開發](https://docs.claude-mem-plus.ai/development)** - 建置、測試、貢獻
- **[疑難排解](https://docs.claude-mem-plus.ai/troubleshooting)** - 常見問題與解決方案
...
詳情請參閱[架構概覽](https://docs.claude-mem-plus.ai/architecture/overview)。
...
詳細範例請參閱[搜尋工具指南](https://docs.claude-mem-plus.ai/usage/search-tools)。
...
有關 Endless Mode 與如何試用的詳情，請參閱 **[Beta 功能文件](https://docs.claude-mem-plus.ai/beta-features)**。
...
設定在 `~/.claude-mem-plus/settings.json` 中管理（首次執行時自動以預設值建立）。設定 AI 模型、Worker 連接埠、資料目錄、日誌層級與脈絡注入設定。

所有可用設定與範例請參閱 **[設定指南](https://docs.claude-mem-plus.ai/configuration)**。

---

## 開發

建置說明、測試與貢獻工作流程請參閱 **[開發指南](https://docs.claude-mem-plus.ai/development)**。
...
常見問題與解決方案請參閱 **[疑難排解指南](https://docs.claude-mem-plus.ai/troubleshooting)**。
...
貢獻工作流程請參閱[開發指南](https://docs.claude-mem-plus.ai/development)。
...
- **儲存庫**：[github.com/bjarne56/claude-mem-plus-plus](https://github.com/bjarne56/claude-mem-plus-plus)
