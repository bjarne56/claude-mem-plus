...
📚 **[Visualizza Documentazione Completa](https://docs.claude-mem-plus.ai/)** - Sfoglia sul sito ufficiale

### Per Iniziare

- **[Guida all'Installazione](https://docs.claude-mem-plus.ai/installation)** - Avvio rapido e installazione avanzata
- **[Guida all'Uso](https://docs.claude-mem-plus.ai/usage/getting-started)** - Come funziona automaticamente Claude-Mem
- **[Strumenti di Ricerca](https://docs.claude-mem-plus.ai/usage/search-tools)** - Interroga la cronologia del progetto con linguaggio naturale
- **[Funzionalità Beta](https://docs.claude-mem-plus.ai/beta-features)** - Prova funzionalità sperimentali come Endless Mode

### Best Practice

- **[Context Engineering](https://docs.claude-mem-plus.ai/context-engineering)** - Principi di ottimizzazione del contesto per agenti AI
- **[Progressive Disclosure](https://docs.claude-mem-plus.ai/progressive-disclosure)** - Filosofia alla base della strategia di priming del contesto di Claude-Mem

### Architettura

- **[Panoramica](https://docs.claude-mem-plus.ai/architecture/overview)** - Componenti del sistema e flusso dei dati
- **[Evoluzione dell'Architettura](https://docs.claude-mem-plus.ai/architecture-evolution)** - Il percorso dalla v3 alla v5
- **[Architettura degli Hook](https://docs.claude-mem-plus.ai/hooks-architecture)** - Come Claude-Mem utilizza gli hook del ciclo di vita
- **[Riferimento Hook](https://docs.claude-mem-plus.ai/architecture/hooks)** - Spiegazione dei 7 script hook
- **[Servizio Worker](https://docs.claude-mem-plus.ai/architecture/worker-service)** - API HTTP e gestione Bun
- **[Database](https://docs.claude-mem-plus.ai/architecture/database)** - Schema SQLite e ricerca FTS5
- **[Architettura di Ricerca](https://docs.claude-mem-plus.ai/architecture/search-architecture)** - Ricerca ibrida con database vettoriale Chroma

### Configurazione e Sviluppo

- **[Configurazione](https://docs.claude-mem-plus.ai/configuration)** - Variabili d'ambiente e impostazioni
- **[Sviluppo](https://docs.claude-mem-plus.ai/development)** - Build, test e flusso di contribuzione
- **[Risoluzione dei Problemi](https://docs.claude-mem-plus.ai/troubleshooting)** - Problemi comuni e soluzioni
...
Vedi [Panoramica dell'Architettura](https://docs.claude-mem-plus.ai/architecture/overview) per i dettagli.
...
Vedi [Guida agli Strumenti di Ricerca](https://docs.claude-mem-plus.ai/usage/search-tools) per esempi dettagliati.
...
Vedi **[Documentazione delle Funzionalità Beta](https://docs.claude-mem-plus.ai/beta-features)** per dettagli su Endless Mode e come provarlo.
...
Le impostazioni sono gestite in `~/.claude-mem-plus/settings.json` (creato automaticamente con valori predefiniti alla prima esecuzione). Configura il modello AI, la porta del worker, la directory dei dati, il livello di log e le impostazioni di iniezione del contesto.

Vedi la **[Guida alla Configurazione](https://docs.claude-mem-plus.ai/configuration)** per tutte le impostazioni disponibili ed esempi.

---

## Sviluppo

Vedi la **[Guida allo Sviluppo](https://docs.claude-mem-plus.ai/development)** per le istruzioni di build, test e flusso di contribuzione.
...
Vedi la **[Guida alla Risoluzione dei Problemi](https://docs.claude-mem-plus.ai/troubleshooting)** per problemi comuni e soluzioni.
...
Vedi [Guida allo Sviluppo](https://docs.claude-mem-plus.ai/development) per il flusso di contribuzione.
...
Copyright (C) 2025 Alex Newman (@bjarne56). Tutti i diritti riservati.
...
- **Problemi**: [GitHub Issues](https://github.com/bjarne56/claude-mem-plus-plus/issues)
- **Repository**: [github.com/bjarne56/claude-mem-plus-plus](https://github.com/bjarne56/claude-mem-plus-plus)
- **Autore**: Alex Newman ([@bjarne56](https://github.com/bjarne56))
