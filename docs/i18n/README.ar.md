...
📚 **[عرض التوثيق الكامل](https://docs.claude-mem-plus.ai/)** - تصفح على الموقع الرسمي

### البدء

- **[دليل التثبيت](https://docs.claude-mem-plus.ai/installation)** - البدء السريع والتثبيت المتقدم
- **[دليل الاستخدام](https://docs.claude-mem-plus.ai/usage/getting-started)** - كيف يعمل Claude-Mem تلقائيًا
- **[أدوات البحث](https://docs.claude-mem-plus.ai/usage/search-tools)** - استعلم عن سجل مشروعك بلغتك
- **[الميزات التجريبية](https://docs.claude-mem-plus.ai/beta-features)** - جرّب الميزات التجريبية مثل Endless Mode

### أفضل الممارسات

- **[هندسة السياق](https://docs.claude-mem-plus.ai/context-engineering)** - مبادئ تحسين سياق وكيل الذكاء الاصطناعي
- **[الكشف التدريجي](https://docs.claude-mem-plus.ai/progressive-disclosure)** - الفلسفة وراء استراتيجية تهيئة السياق في Claude-Mem

### البنية المعمارية

- **[نظرة عامة](https://docs.claude-mem-plus.ai/architecture/overview)** - مكونات النظام وتدفق البيانات
- **[تطور البنية المعمارية](https://docs.claude-mem-plus.ai/architecture-evolution)** - تطور المعمارية من v3 إلى v5
- **[بنية برامج الربط (Hooks)](https://docs.claude-mem-plus.ai/hooks-architecture)** - كيف يستخدم Claude-Mem خطافات دورة الحياة
- **[مرجع برامج الربط (Hooks)](https://docs.claude-mem-plus.ai/architecture/hooks)** - شرح 7 سكريبتات خطافات
- **[خدمة العامل](https://docs.claude-mem-plus.ai/architecture/worker-service)** - HTTP API وإدارة Bun
- **[قاعدة البيانات](https://docs.claude-mem-plus.ai/architecture/database)** - مخطط SQLite وبحث FTS5
- **[بنية البحث](https://docs.claude-mem-plus.ai/architecture/search-architecture)** - البحث المختلط مع قاعدة بيانات المتجهات Chroma

### الإعدادات والتطوير

- **[الإعدادات](https://docs.claude-mem-plus.ai/configuration)** - متغيرات البيئة والإعدادات
- **[التطوير](https://docs.claude-mem-plus.ai/development)** - البناء، الاختبار، سير العمل للمساهمة
- **[استكشاف الأخطاء وإصلاحها](https://docs.claude-mem-plus.ai/troubleshooting)** - المشكلات الشائعة والحلول
...
انظر [نظرة عامة على البنية المعمارية](https://docs.claude-mem-plus.ai/architecture/overview) للتفاصيل.
...
انظر [دليل أدوات البحث](https://docs.claude-mem-plus.ai/usage/search-tools) لأمثلة مفصلة.
...
انظر **[توثيق الميزات التجريبية](https://docs.claude-mem-plus.ai/beta-features)** لتفاصيل حول Endless Mode وكيفية تجربته.
...
تتم إدارة الإعدادات في `~/.claude-mem-plus/settings.json` (يتم إنشاؤه تلقائيًا بالقيم الافتراضية عند التشغيل الأول). قم بتكوين نموذج الذكاء الاصطناعي، منفذ العامل، دليل البيانات، مستوى السجل، وإعدادات حقن السياق.

انظر **[دليل الإعدادات](https://docs.claude-mem-plus.ai/configuration)** لجميع الإعدادات المتاحة والأمثلة.

---

## التطوير

انظر **[دليل التطوير](https://docs.claude-mem-plus.ai/development)** لتعليمات البناء، الاختبار، وسير عمل المساهمة.
...
انظر **[دليل استكشاف الأخطاء وإصلاحها](https://docs.claude-mem-plus.ai/troubleshooting)** للمشكلات الشائعة والحلول.
...
انظر [دليل التطوير](https://docs.claude-mem-plus.ai/development) لسير عمل المساهمة.
...
حقوق النشر (C) 2025 Alex Newman (@bjarne56). جميع الحقوق محفوظة.
...
- **التوثيق**: [docs/](docs/)
- **المشكلات**: [GitHub Issues](https://github.com/bjarne56/claude-mem-plus-plus/issues)
- **المستودع**: [github.com/bjarne56/claude-mem-plus-plus](https://github.com/bjarne56/claude-mem-plus-plus)
- **المؤلف**: Alex Newman ([@bjarne56](https://github.com/bjarne56))
