...
📚 **[Vollständige Dokumentation anzeigen](https://docs.claude-mem-plus.ai/)** - Auf der offiziellen Website durchsuchen

### Erste Schritte

- **[Installationsanleitung](https://docs.claude-mem-plus.ai/installation)** - Schnellstart & erweiterte Installation
- **[Nutzungsanleitung](https://docs.claude-mem-plus.ai/usage/getting-started)** - Wie Claude-Mem automatisch funktioniert
- **[Suchwerkzeuge](https://docs.claude-mem-plus.ai/usage/search-tools)** - Durchsuchen Sie Ihre Projekthistorie mit natürlicher Sprache
- **[Beta-Funktionen](https://docs.claude-mem-plus.ai/beta-features)** - Probieren Sie experimentelle Funktionen wie den Endless Mode

### Best Practices

- **[Context Engineering](https://docs.claude-mem-plus.ai/context-engineering)** - Prinzipien der Kontextoptimierung für KI-Agenten
- **[Progressive Disclosure](https://docs.claude-mem-plus.ai/progressive-disclosure)** - Philosophie hinter Claude-Mems Kontext-Priming-Strategie

### Architektur

- **[Übersicht](https://docs.claude-mem-plus.ai/architecture/overview)** - Systemkomponenten & Datenfluss
- **[Architekturentwicklung](https://docs.claude-mem-plus.ai/architecture-evolution)** - Die Reise von v3 zu v5
- **[Hooks-Architektur](https://docs.claude-mem-plus.ai/hooks-architecture)** - Wie Claude-Mem Lifecycle-Hooks verwendet
- **[Hooks-Referenz](https://docs.claude-mem-plus.ai/architecture/hooks)** - 7 Hook-Skripte erklärt
- **[Worker Service](https://docs.claude-mem-plus.ai/architecture/worker-service)** - HTTP API & Bun-Verwaltung
- **[Datenbank](https://docs.claude-mem-plus.ai/architecture/database)** - SQLite-Schema & FTS5-Suche
- **[Such-Architektur](https://docs.claude-mem-plus.ai/architecture/search-architecture)** - Hybride Suche mit Chroma-Vektordatenbank

### Konfiguration & Entwicklung

- **[Konfiguration](https://docs.claude-mem-plus.ai/configuration)** - Umgebungsvariablen & Einstellungen
- **[Entwicklung](https://docs.claude-mem-plus.ai/development)** - Erstellen, Testen, Beitragen
- **[Fehlerbehebung](https://docs.claude-mem-plus.ai/troubleshooting)** - Häufige Probleme & Lösungen
...
Siehe [Architekturübersicht](https://docs.claude-mem-plus.ai/architecture/overview) für Details.
...
Siehe [Suchwerkzeuge-Anleitung](https://docs.claude-mem-plus.ai/usage/search-tools) für detaillierte Beispiele.
...
Siehe **[Beta-Funktionen-Dokumentation](https://docs.claude-mem-plus.ai/beta-features)** für Details zum Endless Mode und wie Sie ihn ausprobieren können.
...
Einstellungen werden in `~/.claude-mem-plus/settings.json` verwaltet (wird beim ersten Start automatisch mit Standardwerten erstellt). Konfigurieren Sie KI-Modell, Worker-Port, Datenverzeichnis, Log-Level und Kontext-Injektionseinstellungen.

Siehe die **[Konfigurationsanleitung](https://docs.claude-mem-plus.ai/configuration)** für alle verfügbaren Einstellungen und Beispiele.

---

## Entwicklung

Siehe die **[Entwicklungsanleitung](https://docs.claude-mem-plus.ai/development)** für Build-Anweisungen, Tests und Beitrags-Workflow.
...
Siehe die **[Fehlerbehebungsanleitung](https://docs.claude-mem-plus.ai/troubleshooting)** für häufige Probleme und Lösungen.
...
Siehe [Entwicklungsanleitung](https://docs.claude-mem-plus.ai/development) für den Beitrags-Workflow.
...
Copyright (C) 2025 Alex Newman (@bjarne56). Alle Rechte vorbehalten.
