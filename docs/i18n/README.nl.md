...
📚 **[Bekijk Volledige Documentatie](https://docs.claude-mem-plus.ai/)** - Bladeren op de officiële website

### Aan de Slag

- **[Installatiegids](https://docs.claude-mem-plus.ai/installation)** - Snel starten & geavanceerde installatie
- **[Gebruikersgids](https://docs.claude-mem-plus.ai/usage/getting-started)** - Hoe Claude-Mem automatisch werkt
- **[Zoektools](https://docs.claude-mem-plus.ai/usage/search-tools)** - Bevraag je projectgeschiedenis met natuurlijke taal
- **[Bètafuncties](https://docs.claude-mem-plus.ai/beta-features)** - Probeer experimentele functies zoals Endless Mode

### Beste Praktijken

- **[Context Engineering](https://docs.claude-mem-plus.ai/context-engineering)** - AI agent context optimalisatieprincipes
- **[Progressieve Onthulling](https://docs.claude-mem-plus.ai/progressive-disclosure)** - Filosofie achter Claude-Mem's context priming strategie

### Architectuur

- **[Overzicht](https://docs.claude-mem-plus.ai/architecture/overview)** - Systeemcomponenten & gegevensstroom
- **[Architectuurevolutie](https://docs.claude-mem-plus.ai/architecture-evolution)** - De reis van v3 naar v5
- **[Hooks Architectuur](https://docs.claude-mem-plus.ai/hooks-architecture)** - Hoe Claude-Mem lifecycle hooks gebruikt
- **[Hooks Referentie](https://docs.claude-mem-plus.ai/architecture/hooks)** - 7 hook scripts uitgelegd
- **[Worker Service](https://docs.claude-mem-plus.ai/architecture/worker-service)** - HTTP API & Bun beheer
- **[Database](https://docs.claude-mem-plus.ai/architecture/database)** - SQLite schema & FTS5 zoeken
- **[Zoekarchitectuur](https://docs.claude-mem-plus.ai/architecture/search-architecture)** - Hybride zoeken met Chroma vector database

### Configuratie & Ontwikkeling

- **[Configuratie](https://docs.claude-mem-plus.ai/configuration)** - Omgevingsvariabelen & instellingen
- **[Ontwikkeling](https://docs.claude-mem-plus.ai/development)** - Bouwen, testen, bijdragen
- **[Probleemoplossing](https://docs.claude-mem-plus.ai/troubleshooting)** - Veelvoorkomende problemen & oplossingen
...
Zie [Architectuuroverzicht](https://docs.claude-mem-plus.ai/architecture/overview) voor details.
...
Zie [Zoektools Gids](https://docs.claude-mem-plus.ai/usage/search-tools) voor gedetailleerde voorbeelden.
...
Zie **[Bètafuncties Documentatie](https://docs.claude-mem-plus.ai/beta-features)** voor details over Endless Mode en hoe je het kunt proberen.
...
Instellingen worden beheerd in `~/.claude-mem-plus/settings.json` (automatisch aangemaakt met standaardinstellingen bij eerste run). Configureer AI model, worker poort, data directory, logniveau en context injectie-instellingen.

Zie de **[Configuratiegids](https://docs.claude-mem-plus.ai/configuration)** voor alle beschikbare instellingen en voorbeelden.

---

## Ontwikkeling

Zie de **[Ontwikkelingsgids](https://docs.claude-mem-plus.ai/development)** voor bouwinstructies, testen en bijdrageworkflow.
...
Zie de **[Probleemoplossingsgids](https://docs.claude-mem-plus.ai/troubleshooting)** voor veelvoorkomende problemen en oplossingen.
...
Zie [Ontwikkelingsgids](https://docs.claude-mem-plus.ai/development) voor bijdrageworkflow.
...
Copyright (C) 2025 Alex Newman (@bjarne56). Alle rechten voorbehouden.
