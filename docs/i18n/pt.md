...
📚 **[Ver Documentação Completa](https://docs.claude-mem-plus.ai/)** - Navegar no site oficial

### Começando

- **[Guia de Instalação](https://docs.claude-mem-plus.ai/installation)** - Início rápido e instalação avançada
- **[Guia de Uso](https://docs.claude-mem-plus.ai/usage/getting-started)** - Como Claude-Mem funciona automaticamente
- **[Ferramentas de Procura](https://docs.claude-mem-plus.ai/usage/search-tools)** - Consulte seu histórico de projeto com linguagem natural
- **[Recursos Beta](https://docs.claude-mem-plus.ai/beta-features)** - Experimente recursos experimentais como o Endless Mode

### Melhores Práticas

- **[Engenharia de Contexto](https://docs.claude-mem-plus.ai/context-engineering)** - Princípios de otimização de contexto para agentes de IA
- **[Divulgação Progressiva](https://docs.claude-mem-plus.ai/progressive-disclosure)** - Filosofia por trás da estratégia de preparação de contexto do Claude-Mem

### Arquitetura

- **[Visão Geral](https://docs.claude-mem-plus.ai/architecture/overview)** - Componentes do sistema e fluxo de dados
- **[Evolução da Arquitetura](https://docs.claude-mem-plus.ai/architecture-evolution)** - A jornada da v3 à v5
- **[Arquitetura de Hooks](https://docs.claude-mem-plus.ai/hooks-architecture)** - Como Claude-Mem usa hooks de ciclo de vida
- **[Referência de Hooks](https://docs.claude-mem-plus.ai/architecture/hooks)** - 7 scripts de hook explicados
- **[Serviço Worker](https://docs.claude-mem-plus.ai/architecture/worker-service)** - API HTTP e gerenciamento do Bun
- **[Banco de Dados](https://docs.claude-mem-plus.ai/architecture/database)** - Schema SQLite e Procura FTS5
- **[Arquitetura de Procura](https://docs.claude-mem-plus.ai/architecture/search-architecture)** - Procura híbrida com banco de dados vetorial Chroma

### Configuração e Desenvolvimento

- **[Configuração](https://docs.claude-mem-plus.ai/configuration)** - Variáveis de ambiente e configurações
- **[Desenvolvimento](https://docs.claude-mem-plus.ai/development)** - Build, testes e contribuição
- **[Solução de Problemas](https://docs.claude-mem-plus.ai/troubleshooting)** - Problemas comuns e soluções
...
Veja [Visão Geral da Arquitetura](https://docs.claude-mem-plus.ai/architecture/overview) para detalhes.
...
Veja [Guia de Ferramentas de Procura](https://docs.claude-mem-plus.ai/usage/search-tools) para exemplos detalhados.
...
Veja **[Documentação de Recursos Beta](https://docs.claude-mem-plus.ai/beta-features)** para detalhes sobre o Endless Mode e como experimentá-lo.
...
As configurações são gerenciadas em `~/.claude-mem-plus/settings.json` (criado automaticamente com valores padrão na primeira execução). Configure modelo de IA, porta do worker, diretório de dados, nível de log e configurações de injeção de contexto.

Veja o **[Guia de Configuração](https://docs.claude-mem-plus.ai/configuration)** para todas as configurações disponíveis e exemplos.

---

## Desenvolvimento

Veja o **[Guia de Desenvolvimento](https://docs.claude-mem-plus.ai/development)** para instruções de build, testes e fluxo de contribuição.
...
Veja o **[Guia de Solução de Problemas](https://docs.claude-mem-plus.ai/troubleshooting)** para problemas comuns e soluções.
...
Veja [Guia de Desenvolvimento](https://docs.claude-mem-plus.ai/development) para o fluxo de contribuição.
...
Copyright (C) 2025 Alex Newman (@bjarne56). Todos os direitos reservados.
