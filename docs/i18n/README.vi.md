...
📚 **[Xem Tài Liệu Đầy Đủ](https://docs.claude-mem-plus.ai/)** - Duyệt trên trang web chính thức

### Bắt Đầu

- **[Hướng Dẫn Cài Đặt](https://docs.claude-mem-plus.ai/installation)** - Bắt đầu nhanh & cài đặt nâng cao
- **[Hướng Dẫn Sử Dụng](https://docs.claude-mem-plus.ai/usage/getting-started)** - Cách Claude-Mem hoạt động tự động
- **[Công Cụ Tìm Kiếm](https://docs.claude-mem-plus.ai/usage/search-tools)** - Truy vấn lịch sử dự án bằng ngôn ngữ tự nhiên
- **[Tính Năng Beta](https://docs.claude-mem-plus.ai/beta-features)** - Dùng thử các tính năng thử nghiệm như Endless Mode

### Thực Hành Tốt Nhất

- **[Kỹ Thuật Ngữ Cảnh](https://docs.claude-mem-plus.ai/context-engineering)** - Các nguyên tắc tối ưu hóa ngữ cảnh cho AI agent
- **[Tiết Lộ Tuần Tự](https://docs.claude-mem-plus.ai/progressive-disclosure)** - Triết lý đằng sau chiến lược chuẩn bị ngữ cảnh của Claude-Mem

### Kiến Trúc

- **[Tổng Quan](https://docs.claude-mem-plus.ai/architecture/overview)** - Các thành phần hệ thống & luồng dữ liệu
- **[Phát Triển Kiến Trúc](https://docs.claude-mem-plus.ai/architecture-evolution)** - Hành trình từ v3 đến v5
- **[Kiến Trúc Hooks](https://docs.claude-mem-plus.ai/hooks-architecture)** - Cách Claude-Mem sử dụng lifecycle hooks
- **[Tham Chiếu Hooks](https://docs.claude-mem-plus.ai/architecture/hooks)** - Giải thích 7 hook scripts
- **[Worker Service](https://docs.claude-mem-plus.ai/architecture/worker-service)** - HTTP API & quản lý Bun
- **[Cơ Sở Dữ Liệu](https://docs.claude-mem-plus.ai/architecture/database)** - Schema SQLite & tìm kiếm FTS5
- **[Kiến Trúc Tìm Kiếm](https://docs.claude-mem-plus.ai/architecture/search-architecture)** - Tìm kiếm kết hợp với cơ sở dữ liệu vector Chroma

### Cấu Hình & Phát Triển

- **[Cấu Hình](https://docs.claude-mem-plus.ai/configuration)** - Biến môi trường & cài đặt
- **[Phát Triển](https://docs.claude-mem-plus.ai/development)** - Xây dựng, kiểm thử, đóng góp
- **[Khắc Phục Sự Cố](https://docs.claude-mem-plus.ai/troubleshooting)** - Các vấn đề thường gặp & giải pháp
...
Xem [Tổng Quan Kiến Trúc](https://docs.claude-mem-plus.ai/architecture/overview) để biết chi tiết.
...
Xem [Hướng Dẫn Công Cụ Tìm Kiếm](https://docs.claude-mem-plus.ai/usage/search-tools) để biết các ví dụ chi tiết.
...
Xem **[Tài Liệu Tính Năng Beta](https://docs.claude-mem-plus.ai/beta-features)** để biết chi tiết về Endless Mode và cách dùng thử.
...
Cài đặt được quản lý trong `~/.claude-mem-plus/settings.json` (tự động tạo với giá trị mặc định khi chạy lần đầu). Cấu hình mô hình AI, cổng worker, thư mục dữ liệu, mức độ log và cài đặt chèn ngữ cảnh.

Xem **[Hướng Dẫn Cấu Hình](https://docs.claude-mem-plus.ai/configuration)** để biết tất cả các cài đặt và ví dụ có sẵn.

---

## Phát Triển

Xem **[Hướng Dẫn Phát Triển](https://docs.claude-mem-plus.ai/development)** để biết hướng dẫn xây dựng, kiểm thử và quy trình đóng góp.
...
Xem **[Hướng Dẫn Khắc Phục Sự Cố](https://docs.claude-mem-plus.ai/troubleshooting)** để biết các vấn đề thường gặp và giải pháp.
...
Xem [Hướng Dẫn Phát Triển](https://docs.claude-mem-plus.ai/development) để biết quy trình đóng góp.
...
Copyright (C) 2025 Alex Newman (@bjarne56). Bảo lưu mọi quyền.
...
- **Tài Liệu**: [docs/](docs/)
- **Vấn Đề**: [GitHub Issues](https://github.com/bjarne56/claude-mem-plus-plus/issues)
- **Repository**: [github.com/bjarne56/claude-mem-plus-plus](https://github.com/bjarne56/claude-mem-plus-plus)
- **Tác Giả**: Alex Newman ([@bjarne56](https://github.com/bjarne56))
