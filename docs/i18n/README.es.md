...
📚 **[Ver Documentación Completa](https://docs.claude-mem-plus.ai/)** - Navegar en el sitio web oficial

### Primeros Pasos

- **[Guía de Instalación](https://docs.claude-mem-plus.ai/installation)** - Inicio rápido e instalación avanzada
- **[Guía de Uso](https://docs.claude-mem-plus.ai/usage/getting-started)** - Cómo funciona Claude-Mem automáticamente
- **[Herramientas de Búsqueda](https://docs.claude-mem-plus.ai/usage/search-tools)** - Consulta el historial de tu proyecto con lenguaje natural
- **[Características Beta](https://docs.claude-mem-plus.ai/beta-features)** - Prueba características experimentales como Endless Mode

### Mejores Prácticas

- **[Ingeniería de Contexto](https://docs.claude-mem-plus.ai/context-engineering)** - Principios de optimización de contexto para agentes de IA
- **[Divulgación Progresiva](https://docs.claude-mem-plus.ai/progressive-disclosure)** - Filosofía detrás de la estrategia de preparación de contexto de Claude-Mem

### Arquitectura

- **[Descripción General](https://docs.claude-mem-plus.ai/architecture/overview)** - Componentes del sistema y flujo de datos
- **[Evolución de la Arquitectura](https://docs.claude-mem-plus.ai/architecture-evolution)** - El viaje de v3 a v5
- **[Arquitectura de Hooks](https://docs.claude-mem-plus.ai/hooks-architecture)** - Cómo Claude-Mem usa hooks de ciclo de vida
- **[Referencia de Hooks](https://docs.claude-mem-plus.ai/architecture/hooks)** - 7 scripts de hooks explicados
- **[Servicio Worker](https://docs.claude-mem-plus.ai/architecture/worker-service)** - API HTTP y gestión de Bun
- **[Base de Datos](https://docs.claude-mem-plus.ai/architecture/database)** - Esquema SQLite y búsqueda FTS5
- **[Arquitectura de Búsqueda](https://docs.claude-mem-plus.ai/architecture/search-architecture)** - Búsqueda híbrida con base de datos vectorial Chroma

### Configuración y Desarrollo

- **[Configuración](https://docs.claude-mem-plus.ai/configuration)** - Variables de entorno y ajustes
- **[Desarrollo](https://docs.claude-mem-plus.ai/development)** - Compilación, pruebas y contribución
- **[Solución de Problemas](https://docs.claude-mem-plus.ai/troubleshooting)** - Problemas comunes y soluciones
...
Ver [Descripción General de la Arquitectura](https://docs.claude-mem-plus.ai/architecture/overview) para más detalles.
...
Ver [Guía de Herramientas de Búsqueda](https://docs.claude-mem-plus.ai/usage/search-tools) para ejemplos detallados.
...
Ver **[Documentación de Características Beta](https://docs.claude-mem-plus.ai/beta-features)** para detalles sobre Endless Mode y cómo probarlo.
...
Los ajustes se gestionan en `~/.claude-mem-plus/settings.json` (se crea automáticamente con valores predeterminados en la primera ejecución). Configura el modelo de IA, puerto del worker, directorio de datos, nivel de registro y ajustes de inyección de contexto.

Ver la **[Guía de Configuración](https://docs.claude-mem-plus.ai/configuration)** para todos los ajustes disponibles y ejemplos.

---

## Desarrollo

Ver la **[Guía de Desarrollo](https://docs.claude-mem-plus.ai/development)** para instrucciones de compilación, pruebas y flujo de contribución.
...
Ver la **[Guía de Solución de Problemas](https://docs.claude-mem-plus.ai/troubleshooting)** para problemas comunes y soluciones.
...
Ver [Guía de Desarrollo](https://docs.claude-mem-plus.ai/development) para el flujo de contribución.
...
Copyright (C) 2025 Alex Newman (@bjarne56). Todos los derechos reservados.
...
- **Problemas**: [GitHub Issues](https://github.com/bjarne56/claude-mem-plus-plus/issues)
