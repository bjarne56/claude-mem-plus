...
📚 **[Visa fullständig dokumentation](https://docs.claude-mem-plus.ai/)** - Bläddra på den officiella webbplatsen

### Komma igång

- **[Installationsguide](https://docs.claude-mem-plus.ai/installation)** - Snabbstart och avancerad installation
- **[Användarguide](https://docs.claude-mem-plus.ai/usage/getting-started)** - Hur Claude-Mem fungerar automatiskt
- **[Sökverktyg](https://docs.claude-mem-plus.ai/usage/search-tools)** - Sök i din projekthistorik med naturligt språk
- **[Betafunktioner](https://docs.claude-mem-plus.ai/beta-features)** - Testa experimentella funktioner som Endless Mode

### Bästa praxis

- **[Context Engineering](https://docs.claude-mem-plus.ai/context-engineering)** - Optimeringsmetoder för AI-agentkontext
- **[Progressiv visning](https://docs.claude-mem-plus.ai/progressive-disclosure)** - Filosofin bakom Claude-Mems kontextpriming-strategi

### Arkitektur

- **[Översikt](https://docs.claude-mem-plus.ai/architecture/overview)** - Systemkomponenter och dataflöde
- **[Arkitekturutveckling](https://docs.claude-mem-plus.ai/architecture-evolution)** - Resan från v3 till v5
- **[Hooks-arkitektur](https://docs.claude-mem-plus.ai/hooks-architecture)** - Hur Claude-Mem använder livscykelkrokar
- **[Hooks-referens](https://docs.claude-mem-plus.ai/architecture/hooks)** - 7 hook-skript förklarade
- **[Worker Service](https://docs.claude-mem-plus.ai/architecture/worker-service)** - HTTP API och Bun-hantering
- **[Databas](https://docs.claude-mem-plus.ai/architecture/database)** - SQLite-schema och FTS5-sökning
- **[Sökarkitektur](https://docs.claude-mem-plus.ai/architecture/search-architecture)** - Hybridsökning med Chroma-vektordatabas

### Konfiguration och utveckling

- **[Konfiguration](https://docs.claude-mem-plus.ai/configuration)** - Miljövariabler och inställningar
- **[Utveckling](https://docs.claude-mem-plus.ai/development)** - Bygga, testa, bidra
- **[Felsökning](https://docs.claude-mem-plus.ai/troubleshooting)** - Vanliga problem och lösningar
...
Se [Arkitekturöversikt](https://docs.claude-mem-plus.ai/architecture/overview) för detaljer.
...
Se [Sökverktygsguide](https://docs.claude-mem-plus.ai/usage/search-tools) för detaljerade exempel.
...
Se **[Dokumentation för betafunktioner](https://docs.claude-mem-plus.ai/beta-features)** för detaljer om Endless Mode och hur du testar det.
...
Inställningar hanteras i `~/.claude-mem-plus/settings.json` (skapas automatiskt med standardvärden vid första körning). Konfigurera AI-modell, worker-port, datakatalog, loggnivå och kontextinjektionsinställningar.

Se **[Konfigurationsguide](https://docs.claude-mem-plus.ai/configuration)** för alla tillgängliga inställningar och exempel.

---

## Utveckling

Se **[Utvecklingsguide](https://docs.claude-mem-plus.ai/development)** för bygginstruktioner, testning och bidragsarbetsflöde.
...
Se **[Felsökningsguide](https://docs.claude-mem-plus.ai/troubleshooting)** för vanliga problem och lösningar.
...
Se [Utvecklingsguide](https://docs.claude-mem-plus.ai/development) för bidragsarbetsflöde.
...
Copyright (C) 2025 Alex Newman (@bjarne56). Alla rättigheter förbehållna.
...
- **Problem**: [GitHub Issues](https://github.com/bjarne56/claude-mem-plus-plus/issues)
- **Repository**: [github.com/bjarne56/claude-mem-plus-plus](https://github.com/bjarne56/claude-mem-plus-plus)
- **Författare**: Alex Newman ([@bjarne56](https://github.com/bjarne56))
