...
**Location:** `/Users/YOUR_USERNAME/.claude/plugins/marketplaces/bjarne56/plugin/scripts/mcp-server.cjs`
...
The 3-layer workflow embodies **progressive disclosure** - a core principle of claude-mem-plus's architecture.
...
2. Check database: `ls ~/.claude-mem-plus/claude-mem.db`
