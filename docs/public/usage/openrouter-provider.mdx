...
| `CLAUDE_MEM_OPENROUTER_APP_NAME` | string | `claude-mem-plus` | Optional: App name for analytics |
...
Either:
- Set `CLAUDE_MEM_OPENROUTER_API_KEY` in `~/.claude-mem-plus/settings.json`, or
...
HTTP-Referer: https://github.com/bjarne56/claude-mem-plus-plus
X-Title: claude-mem-plus
