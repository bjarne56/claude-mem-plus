...
Either:
- Set `CLAUDE_MEM_GEMINI_API_KEY` in `~/.claude-mem-plus/settings.json`, or
...
<Tip>
**Recommended**: Enable billing on your Google Cloud project to unlock much higher rate limits. You won't be charged unless you exceed the generous free quota. This allows claude-mem-plus to process observations instantly instead of waiting between requests.
</Tip>
