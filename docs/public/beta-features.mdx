...
**Your memory data is always preserved.** The database at `~/.claude-mem-plus/claude-mem.db` is not affected by version switching. All your observations, sessions, and summaries remain intact.
...
- Open an issue at [GitHub Issues](https://github.com/bjarne56/claude-mem-plus-plus/issues)
