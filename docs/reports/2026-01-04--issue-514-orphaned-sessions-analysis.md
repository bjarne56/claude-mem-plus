...
Filesystem analysis of `~/.claude/projects/-Users-alexnewman-Scripts-claude-mem-plus/`:
...
The .jsonl files are created by the **Claude Agent SDK** (`@anthropic-ai/claude-agent-sdk`), not by claude-mem-plus directly.
