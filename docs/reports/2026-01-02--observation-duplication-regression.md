...
**File: `/Users/alexnewman/Scripts/claude-mem-plus/src/services/worker/SDKAgent.ts`**
...
**File: `/Users/alexnewman/Scripts/claude-mem-plus/src/services/sqlite/PendingMessageStore.ts`**
...
**File: `/Users/alexnewman/Scripts/claude-mem-plus/src/services/sqlite/SessionStore.ts`**
...
```bash
cd /Users/alexnewman/Scripts/claude-mem-plus
...
- Cleanup script: `/Users/alexnewman/Scripts/claude-mem-plus/src/bin/cleanup-duplicates.ts`
