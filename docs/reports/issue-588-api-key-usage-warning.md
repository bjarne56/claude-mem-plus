...
1. User installs claude-mem-plus plugin via marketplace
...
### How claude-mem-plus Uses the Claude Agent SDK

Claude-mem uses `@anthropic-ai/claude-agent-sdk` (version ^0.1.76) for AI-powered operations:

**File:** `/Users/alexnewman/conductor/workspaces/claude-mem-plus/budapest/src/services/worker/SDKAgent.ts`
...
**File:** `/Users/alexnewman/conductor/workspaces/claude-mem-plus/budapest/src/services/worker-service.ts`
...
**File:** `/Users/alexnewman/conductor/workspaces/claude-mem-plus/budapest/src/services/infrastructure/ProcessManager.ts`
...
**File:** `/Users/alexnewman/conductor/workspaces/claude-mem-plus/budapest/src/services/worker/GeminiAgent.ts`
...
**File:** `/Users/alexnewman/conductor/workspaces/claude-mem-plus/budapest/src/services/worker/OpenRouterAgent.ts`
...
```
[claude-mem-plus] IMPORTANT: This plugin uses the Claude Agent SDK for AI operations.
...
To avoid charges, configure an alternative provider in ~/.claude-mem-plus/settings.json:
...
```
[claude-mem-plus] Processing 25 observations
...
1. Check your provider setting: `~/.claude-mem-plus/settings.json`
