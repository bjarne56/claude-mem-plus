# claude-mem-plus Architecture Overview
...
|-------|---------|-------------|---------|
| Setup | version-check.js | Sub-100ms version-marker check; prompts `npx claude-mem-plus repair` on mismatch | 60s |
