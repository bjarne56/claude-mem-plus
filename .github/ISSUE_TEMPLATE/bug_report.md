...
**Plugin Paths:**
- **macOS/Linux**: `~/.claude/plugins/marketplaces/bjarne56`
- **Windows**: `%USERPROFILE%\.claude\plugins\marketplaces\bjarne56`
...
- **Path**: `~/.claude-mem-plus/logs/worker-YYYY-MM-DD.log`
- **Example**: `~/.claude-mem-plus/logs/worker-2025-12-14.log`
