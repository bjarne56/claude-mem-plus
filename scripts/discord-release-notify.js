...
async function postToDiscord(webhookUrl, version, notes) {
  ...
  const repoUrl = 'https://github.com/bjarne56/claude-mem-plus-plus';

  const payload = {
    embeds: [
      {
        title: `🚀 claude-mem-plus ${version} released`,
        ...
        fields: [
          ...
          {
            name: '📚 Docs',
            value: '[docs.claude-mem-plus.ai](https://docs.claude-mem-plus.ai)',
            inline: true,
          },
        ],
        footer: {
          text: 'claude-mem-plus • Persistent memory for Claude Code',
        },
