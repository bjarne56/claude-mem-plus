...
// fork: 保留 writeConfigAndShowCodexInstructions(上游 v12.7.2 把它内联了,
// 但 fork 旧调用方仍需要这个 helper;命名空间已替换为 claude-mem-plus)
...
export function uninstallCodexCli(): number {
  ...
  console.log('Restart claude-mem-plus worker + Codex CLI to apply changes.\n');
